...
}
{
    ...
    HotelModelDefines.SL2_TVAPI_I32_HOTEL_ON_CHANNEL_CTRL = "tvapi.i32.hotel.on.channel.ctrl";
    ...
    HotelModelDefines.SL2_TVAPI_ACTION_HOTEL_UPLOAD_LOGO_FROM_USB = "tvapi.action.hotel.upload.logo.from.usb";
...
function HotelModel(parentModel) {
    ...
    this.registerSubObject = function () {
        ...
        // on channel
        this.registerIntegerObject(
            HotelModelDefines.SL2_TVAPI_I32_HOTEL_ON_CHANNEL_CTRL,
            "getOnChannel", "setOnChannel", "onChannelChaged",
            null, null);
// Need to fix
//	HotelModelDefines.SL2_TVAPI_ACTION_HOTEL_COPY_TO_USB=  "tvapi.action.hotel.copy.to.usb "
...
//	HotelModelDefines.SL2_TVAPI_ACTION_HOTEL_RECOVER_FROM_USB=  "tvapi.action.hotel.recover.from.usb "
        ...
        // UploadLogoFromUsb
        this.registerActionObject(
            HotelModelDefines.SL2_TVAPI_ACTION_HOTEL_UPLOAD_LOGO_FROM_USB,
            [
                {
                    name: "UploadLogoFromUsb", method: function (object, path) {
                    return object.invoke(path);
                }
                }
            ], "UploadLogoResult"
