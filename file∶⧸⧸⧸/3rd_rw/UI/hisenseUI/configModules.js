...
var modulesConfig = [
    {
        ...
        "handler": {
            ...
            keyNum1Handler: "setDefaultDataStatus",
            keyNum6Handler: "setDefaultDataStatus",
            keyNum9Handler: "setDefaultDataStatus"
        },
...
//                    }
            ...
            {//
                ...
                //"firstFocusId": "setting_qsp_ul",
                //以上三项配置必须完全符合
                "brand": ["kal","riv","adm","tel","pan","bgh"],   //空值为All，“-”表示排除，，以第一个为准
...
//                    }
            ...
            {//
                ...
                //"firstFocusId": "setting_qsp_ul",
                //以上三项配置必须完全符合
                "brand": ["avi","ezy","shp","ame","jvc","pio","psc","nob","san","phi","ilo","sei","ton","blu","cha","fam","dev"],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/epos/SA_5655_OEM/epos.js",
                "htmlPath": "UI/hisenseUI/modulePages/epos/SA_5655_OEM/epos.html",
                "cssPath": "css/epos_sa_5655_oem.css"
//                    "handler": {
//                        "aftEscHandler": "exitSKBLan"
//                    }
            },
...
/**--------------------- app page beg ---------------------**/
    {
        "id": "appControl",
        "module": "app",
        "jsPath": "modulePages/appPages/appControl.js",
        "htmlPath": "",
        "cssPath": "",
    ...
    {
        "id": "appCtrNetworkDisconnectDialog",
        "module": "app",
        "jsPath": "modulePages/appPages/networkDisconnectDialog.js",
        "htmlPath": "UI/hisenseUI/modulePages/appPages/networkDisconnectDialog.html",
        "cssPath": "css/livetv/searchDialog.css",
        "description": "page",
        "pageMode": "module",
        "firstFocusId": "appCtrlNetDisBtn",
        "groupNavMode": "nearest",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "appCtrlNetDisconnectDialog.getPageData",
        "onCreate": "",
        "onOpen": "appCtrlNetDisconnectDialog.onOpen",
        "onClose": "",
        "onFocus": "",
        "onDestroy": "appCtrlNetDisconnectDialog.onDestroy",
        "pageData": {},
        "handler": {
            befEscHandler: "appCtrlNetDisconnectDialog.aftEscHandler"
        },
        "keys": {
            "enable": [VK_ENTER,VK_BACK],
            "disable": []
        }
    },
    {
    ...
    },
    {
        "id": "app_4k-epos",
        "module": "app",
        "jsPath": "modulePages/appPages/4k-epos.js",
        "htmlPath": "",
        "cssPath": "",
        "description": "app 4k-epos",
        "pageMode": "module",
        "firstFocusId": "",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        ...
        "handler": {},
        "AutoClose": false,
        "initData": 'get4KEposPageData',
        "onCreate": "",
        "onOpen": "app4KEpos.onOpen4KEpos",
        "onClose": "app4KEpos.onClose4KEpos",
        "onFocus": "",
        "onBlur": "",
        "onDestroy": "app4KEpos.onClose4KEpos",
        "pageData": {}
    },
    {
        "id": "app_web",
...
/**--------------------- wizard  page start ---------------------**/

    {
        ...
        "jsPath": "modulePages/boe/sa/boe_bg_page.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_background.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_index_sa.css",
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_bg_page_id",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_bg_page.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_background.html",
                "cssPath": "css/boe_index_sa.css"
            },
            {
                "subId": "boe_bg_page_id",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_bg_page.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_background.html",
                "cssPath": "css/boe_index_eu.css"
            }
        ]
    ...
    },
    {
        "id": "boe_lang_page_id",
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_lang.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_lang.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_index_sa.css",
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_lang.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_lang.html",
                "cssPath": "css/boe_index_sa.css"
            },
            {
                "subId": "boe_bg_page_id",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_lang.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_lang.html",
                "cssPath": "css/boe_index_eu.css"
            }
        ]
    },
    {
        "id": "boe_cty_page_id",
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_cty.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_cty.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "modulePages/epg.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_index_sa.css",
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_cty_page_id",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_cty.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_cty.html",
                "cssPath": "css/boe_index_sa.css"
            },
            {
                "subId": "boe_cty_page_id",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_cty.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_cty.html",
                "cssPath": "css/boe_index_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_timezone.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_timezone.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "modulePages/epg.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_index_sa.css",
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_timezone_page_id",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_timezone.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_timezone.html",
                "cssPath": "css/boe_index_sa.css"
            },
            {
                "subId": "boe_timezone_page_id",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_timezone.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_timezone.html",
                "cssPath": "css/boe_index_eu.css"
            }
        ]
    },
    {
        "id": "boe_usemode_page_id",
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_usemode.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_usemode.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_index_sa.css",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "boeUsemodeGridUl",//包括button或者Component
        "handler": {
            "aftEscHandler": "boeUsemodeToTimezonePage"
        },
        "initData": "getboeUsemodePageData",//页面创建前的回调函数
        //"AutoClose": true,
        //"AutoCloseTimeLength": 600,
        "onCreate": "",                 //页面创建时的回调函数
        "onOpen": "boeUsemodePageOnOpen",                            //页面创建时的回调函数
        "onClose": "",    //页面创建时的回调函数
        "onDestroy": "boeUseModeOnDestroy",  //页面创建时的回调函数
        "keys": {
            "disable": [
                VK_MENU, VK_EPG, VK_INFO, VK_MUTE, VK_VOLUME_DOWN, VK_VOLUME_UP, VK_NETFLIX
            ]
        },
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_usemode_page_id",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_usemode.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_usemode.html",
                "cssPath": "css/boe_index_sa.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_complete.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_complete.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "pageMode": "module",//可指定module,single,dialog
        "cssPath": "css/boe_index_sa.css",
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_complete_page_id",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_complete.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_complete.html",
                "cssPath": "css/boe_index_sa.css",
                "firstFocusId": "complete_btn_ok"
            },
            {
                "subId": "boe_complete_page_id",
                "areas": ["EU"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_complete.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_complete.html",
                "cssPath": "css/boe_index_eu.css",
                "firstFocusId": "complete_btn_no"
            }
        ]
...
//            "groupNavMode": "nearest",//nearest,sequence
    ...
    },
    {
        ...
        "module": "wizard",
        "jsPath": "modulePages/boe/sa/boe_disclaimer.js",
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_disclaimer.html",
        "cssPath": "css/boe_index_sa.css",
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            ...
            },
            {
                ...
                "country": [],
                //以上三项配置必须完全符合
                "brand": ['jvc','pio','psc','nob','shp','san','phi','ilo','sei','ton'],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/boe/sa/boe_disclaimer_newsan.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_disclaimer_newsan.html",
                "cssPath": "css/boe_index_sa.css"
            },
            {
                "subId": "boe_disclaimer_page_id",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_disclaimer.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_disclaimer.html",
                "cssPath": "css/boe_index_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",
        "jsPath": "modulePages/boe/sa/boe_dis_info.js",
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_dis_info.html",
        "cssPath": "css/boe_index_sa.css",
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            ...
            },
            {
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_dis_info.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_dis_info.html",
                "cssPath": "css/boe_index_eu.css"
            }
...
/**************************  开机导航 网络设置模块   begin  **********************************/
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_network.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_network.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_index_sa.css",
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_network_page_id",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_network.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_network.html",
                "cssPath": "css/boe_index_sa.css"
            },
            {
                "subId": "boe_network_page_id",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_network.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_network.html",
                "cssPath": "css/boe_index_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_netbg.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_netbg.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_netbg_page_id",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_netbg.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_netbg.html",
                "cssPath": "css/boe_index_sa.css"
            },
            {
                "subId": "boe_netbg_page_id",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_netbg.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_netbg.html",
                "cssPath": "css/boe_index_eu.css"
            }
    ...
    },
    {
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_ethernet_result",
                "areas": ["EU"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_ethernet_result.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_ethernet_result.html",
                "cssPath": "css/boe_network_eu.css"
            }
        ]
    ...
    },
    {
        "id": "boe_search_wifi",
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_search_wifi.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_search_wifi.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_network_sa.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_search_wifi",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_search_wifi.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_search_wifi.html",
                "cssPath": "css/boe_network_sa.css"
            },
            {
                "subId": "boe_search_wifi",
                "areas": ["EU"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_search_wifi.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_search_wifi.html",
                "cssPath": "css/boe_network_eu.css"
            }
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_search_ethernet",
                "areas": ["EU"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_search_ethernet.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_search_ethernet.html",
                "cssPath": "css/boe_network_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_NetSetWifiNotPlugin.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetSetWifiNotPlugin.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_network_sa.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "setting network set search wifi dialog ",
        "pageMode": "module",//可指定module,single,dialog
        //"AutoClose": true,
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_wifi_notplugin",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_NetSetWifiNotPlugin.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetSetWifiNotPlugin.html",
                "cssPath": "css/boe_network_sa.css"
            },
            {
                "subId": "boe_wifi_notplugin",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_NetSetWifiNotPlugin.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_NetSetWifiNotPlugin.html",
                "cssPath": "css/boe_network_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_NetworkWifiSetPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkWifiSetPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_network_sa.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "handler": {
            ...
            "befLeftHandler": "networkBgPageAftLeftHandler",
            "befRightHandler": "networkBgPageAftRightHandler"
        },
...
//            "onFocus": "wizardNetSetWifiAutoListFoucsHandler",
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_NetworkWifiSetPage",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_NetworkWifiSetPage.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkWifiSetPage.html",
                "cssPath": "css/boe_network_sa.css"
            },
            {
                "subId": "boe_NetworkWifiSetPage",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_NetworkWifiSetPage.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_NetworkWifiSetPage.html",
                "cssPath": "css/boe_network_eu.css"
            }
...
//            "onFocus": "wizardNetSetWifiAutoListFoucsHandler",
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_NetworkWifiWPS",
                "areas": ["EU"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_NetworkWifiPWInputDialog.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_NetworkWifiPWInputDialog.html",
                "cssPath": "css/boe_network_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_NetworkWifiPWInputDialog.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkWifiPWInputDialog.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_network_sa.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "navigation wifi set page ",
        "pageMode": "module",//可指定module,single,dialog
...
//            "onFocus": "wizardNetSetWifiAutoListFoucsHandler",
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_NetworkWifiPWInputDialog",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_NetworkWifiPWInputDialog.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkWifiPWInputDialog.html",
                "cssPath": "css/boe_network_sa.css"
            },
            {
                "subId": "boe_NetworkWifiPWInputDialog",
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_NetworkWifiAddDialog.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkWifiAddDialog.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_network_sa.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_NetworkWifiAddDialog",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_NetworkWifiAddDialog.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkWifiAddDialog.html",
                "cssPath": "css/boe_network_sa.css"
            },
            {
                "subId": "boe_NetworkWifiAddDialog",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_NetworkWifiAddDialog.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_NetworkWifiAddDialog.html",
                "cssPath": "css/boe_network_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_NetworkConnNetDialog.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkConnNetDialog.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_network_sa.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_NetworkConnNetDialog",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_NetworkConnNetDialog.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkConnNetDialog.html",
                "cssPath": "css/boe_network_sa.css"
            },
            {
                "subId": "boe_NetworkConnNetDialog",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_NetworkConnNetDialog.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_NetworkConnNetDialog.html",
                "cssPath": "css/boe_network_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_NetworkConnResDialog.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkConnResDialog.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_network_sa.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_NetworkConnResDialog",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_NetworkConnResDialog.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkConnResDialog.html",
                "cssPath": "css/boe_network_sa.css"
            },
            {
                "subId": "boe_NetworkConnResDialog",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_NetworkConnResDialog.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_NetworkConnResDialog.html",
                "cssPath": "css/boe_network_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_NetworkEthernetType.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkEthernetType.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_network_sa.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "setting network set connect network result dialog ",
        "pageMode": "module",//可指定module,single,dialog
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_NetworkEthernetType",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_NetworkEthernetType.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkEthernetType.html",
                "cssPath": "css/boe_network_sa.css"
            },
            {
                "subId": "boe_NetworkEthernetType",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_NetworkEthernetType.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_NetworkEthernetType.html",
                "cssPath": "css/boe_network_eu.css"
            }
    ...
    },
    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "jsPath": "modulePages/boe/sa/boe_NetworkEthernetSetPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkEthernetSetPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/boe_network_sa.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "boe_NetworkEthernetSetPage",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/sa/boe_NetworkEthernetSetPage.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_NetworkEthernetSetPage.html",
                "cssPath": "css/boe_network_sa.css"
            },
            {
                "subId": "boe_NetworkEthernetSetPage",
                ...
                "subAreas": [],
                "country": [],
                "jsPath": "modulePages/boe/eu/boe_NetworkEthernetSetPage.js",
                "htmlPath": "UI/hisenseUI/modulePages/boe/eu/boe_NetworkEthernetSetPage.html",
                "cssPath": "css/boe_network_eu.css"
            }
...
/**************************  开机导航 网络设置模块   end **********************************/
...

    {
        ...
        "module": "wizard",                         //表示页面所属模块
        "areas": ["SA"],
        "jsPath": "modulePages/boe/sa/boe_input_source.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/boe/sa/boe_input_source.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "modulePages/epg.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath":"css/boe_index_sa.css",
...
/***********************Store Mode Seller Setting******************************/
    {
        "id": "setting_sys_seller_setting_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/settingSellerSettingPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingSellerSettingPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/settingSelllerSettingPage.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "seller setting page",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_sellerSetting_ul",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "AutoClose": true,
//            "isStatic":false,
        ...
        "CaE": [],
        "initData": "getSellerSettingSetupPageData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "SellerSettingOpenHandler",                            //页面创建时的回调函数
        "onClose": "SellerSettingCloseHandler",                        //页面创建时的回调函数
        "onDestroy": "sellerSettingOnDestroy",                       //页面创建时的回调函数
        "pageData": {},
        "handler": {
            "aftEscHandler": "sellerSettingEscHandler"
        }
    },
 /*   {
        "id": "setting_sys_auto_play_setup_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingAutoPlaybackSetup.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingAutoPlaybackSetup.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
            "cssPath": "css/settingepos.css",        //
        "description": "settting auto playback setup page",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_sys_auto_play_setup_ul1",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            "aftEscHandler": "SettingAutoPlaybackSetupEscHandler"
        },
        "initData": "getSettingAutoPlaybackSetupPageData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "SettingAutoPlaybackSetupPageOnDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },*/
    {
        "id": "setting_storeMode_update_dialog_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingStoreModeUpdateDialog.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingStoreModeUpdateDialog.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "settting Store mode update dialog",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_update_storeMode_dialog_text",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingStoreModeUpdateDialogPageData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "SettingStoreModeUpdateDialogonOpen",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "SettingStoreModeUpdateDialogonDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    {
        "id": "setting_ss_mall_logo_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingSSMallLogo.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingSSMallLogo.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/settingSelllerSettingPage.css",
        "description": "seller settings select mall logo",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_ss_mall_logo_ul1",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingSSMallLogoPageData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "SettingSSMallLogoonOpen",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "SettingSSMallLogoonDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    {
        "id": "setting_ss_language_selection_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingSSLanguageSelection.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingSSLanguageSelection.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/settingSelllerSettingPage.css",
        "description": "seller settings language selection",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_ss_language_selection_ul1",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingSSLanguageSelectionPageData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "SettingSSLanguageSelectiononOpen",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "SettingSSLanguageSelectiononDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    {
        "id": "setting_initiate_Store_mode_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/settingInitiateStoreMode.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingInitiateStoreMode.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "initiate Store mode page",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "settingInitiateStoreModeEnter",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingInitiateStoreModeData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "settingInitiateStoreModePageOnOpen",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "settingInitiateStoreModeOnDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    /*内置视频和内置图片更新失败页面*/
    {
        "id": "setting_storeMode_update_fail_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/settingStoreModeUpdateFailPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingStoreModeUpdateFailPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/settingSelllerSettingPage.css",
        "description": "Store mode update fail page",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "settingStoreModeUpdateFailRetry",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingStoreModeUpdateFailData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "settingStoreModeUpdateFailPageOnOpen",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "settingStoreModeUpdateFailOnDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    {
        "id": "setting_mall_logo_fail_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingMallLogoFailPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingMallLogoFailPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "mall logo fail page",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "settingMallLogoFailCancel",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingMallLogoFailData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "settingMallLogoFailPageOnOpen",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "settingMallLogoFailOnDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    {
        "id": "setting_StoreMode_Mseeage_Dialog_Page",
        "description": "Mode sample page",
        "pageMode": "module",
        "firstFocusId": "settingStoreModeMessageDialogInfo",
        "module": "setting",
        "jsPath": "modulePages/setting/settingStoreModeMessageDialog.js",
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingStoreModeMessageDialog.html",
        "cssPath": "",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getStoreModeMessageDialogData",
        "onCreate": "",
        "onOpen": "StoreModeMessageDialogOnOpen",
        "onClose": "",
        "onDestroy": "StoreModeMessageDialogOnDestroy",
        "pageData": {},
        "handler": {
            "aftEscHandler": ""
        },
    ...
    ////////////////////////////////////////////////////////No upgrade package detected
    {
        "id": "setting_storeMode_Toast_Page",
        "description": "Mode sample page",
        "pageMode": "module",
        "firstFocusId": "store_mode_message_toast_text",
        "module": "setting",
        "jsPath": "modulePages/setting/SettingStoreModeToast.js",
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingStoreModeToast.html",
        "cssPath": "",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getStoreModeToastData",
        "onCreate": "",
        "onOpen": "StoreModeToastOnOpen",
        "onClose": "",
        "onDestroy": "StoreModeToastOnDestroy",
        "pageData": {},
        "handler": {
            "aftEscHandler": ""
        },
...
//            "isStatic":false,
        ...
        "handler": {
            ...
            "keyNum0Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "keyNum1Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "keyNum2Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "keyNum3Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "keyNum4Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "keyNum5Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "keyNum6Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "keyNum7Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "keyNum8Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "keyNum9Handler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "befDownHandler": "numberKeyAndUpDownKeyHandlrOnQsPage",
            "befUpHandler": "numberKeyAndUpDownKeyHandlrOnQsPage"
        },
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "onCreate": "SettingFirOnCreate",                        //页面创建时的回调函数
...
//            "groupNavMode": "nearest",//nearest,sequence
    ...
    },
    {
        ...
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingTimePage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingTimePage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "settting system time page",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_sys_time_mode_btn",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
...
//            "groupNavMode": "nearest",//nearest,sequence
        ...
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "SettingSysAppSetonOpen",                  //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                ...
                "onOpen": "SettingSysAppSetonOpen",
                "firstFocusId": "setting_sys_app_switch1_control1"
//                    "cssPath": ""
//                    "handler": {
//                        "aftEscHandler": "exitSKBLan"
//                    }
...
//            "groupNavMode": "nearest",//nearest,sequence
    ...
    {
        "id": "setting_update_dialog2_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingUpdateDialog2.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingUpdateDialog2.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "update disk check page",
        "AutoClose": false,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_update_dialog2_btn1",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "settingUpdatedialog2PageData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "settingUpdatedialog2onDestroy",                       //页面创建时的回调函数
        "pageData": {}
        //"keys": {
        //    "enable": [VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT, VK_ENTER, VK_BACK],
        //    "disable": []
    ...
    {
        "id": "settingUpgradeSpaceId",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingUpgradeNotEnoughSpace.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingUpgradeNotEnoughSpace.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/SettingUpgradeMemoryPage.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "settingUpgradeSpaceBtn",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            "aftEscHandler": "settingUpgradeSpaceOk"
        },
        "AutoClose": false,
//            "AutoCloseTimeLength":30,
        "initData": "getSettingUpgradeSpacePageData",//页面创建前的回调函数
        "onCreate": "",                 //页面创建时的回调函数
        "onOpen": "",                            //页面创建时的回调函数
        "onClose": "",    //页面创建时的回调函数
        "onDestroy": "settingUpgradeSpaceOnDestroy",  //页面创建时的回调函数
        "pageData": {},                          //此处节点可以为空，如果为空，则可利用导入Js文件中函数，在onCreate中进行赋值
        "keys": {
            "enable": [ VK_LEFT, VK_RIGHT, VK_ENTER, VK_BACK,VK_ESCAPE],
            "disable": []
        }
    },
    {
        "id": "settingUpgradeMemoryId",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingUpgradeMemoryPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingUpgradeMemoryPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/SettingUpgradeMemoryPage.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "settingUpgradeMemoryOk",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            "aftEscHandler": "settingUpgradeMemoryEscHandle"
        },
        "AutoClose": false,
//            "AutoCloseTimeLength":30,
        "initData": "getsettingUpgradeMemoryData",//页面创建前的回调函数
        "onCreate": "",                 //页面创建时的回调函数
        "onOpen": "settingUpgradeMemoryOnOpen",                            //页面创建时的回调函数
        "onClose": "",    //页面创建时的回调函数
        "onDestroy": "settingMemoryOnDestroy",  //页面创建时的回调函数
        "pageData": {},                          //此处节点可以为空，如果为空，则可利用导入Js文件中函数，在onCreate中进行赋值
        "keys": {
            "enable": [ VK_LEFT, VK_RIGHT, VK_ENTER, VK_BACK,VK_ESCAPE],
            "disable": []
    ...
    {
        "id": "setting_update_disclaimer_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingUpgradeDisclaimer.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingUpgradeDisclaimer.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "disclaimer page",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_sys_update_disclaimer_box",//包括button或者Component
        //"groupNavMode": "",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getUpdateVersionDataDisclaimer", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "DisclaimerPageOpenHandler",                            //页面创建时的回调函数
        "onClose": "DisclaimerClosenHandler",                        //页面创建时的回调函数
        "onDestroy": "SettingSysDisclaimerPageonDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    {
...
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        ...
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_sys_ad_pvr_btn",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
...
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        ...
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_sys_update_btn1",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
...
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        ...
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_sys_opensrc_btn1",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingSysOpenSrcData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "openSrcOpenHandler",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "SettingSysOpenSrconDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    {
...
//            "groupNavMode": "nearest",//nearest,sequence
    ...
    {
        "id": "SettingCIVersionInfoPage",
        "module": "setting",
        "jsPath": "modulePages/setting/SettingCIVersionInfo.js",
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingCIVersionInfo.html",
        "description": "Host diagnostic screen",
        "AutoClose": true,
        "pageMode": "module",
        "firstFocusId": "user_entry_ver_btn1",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getUserEntryPageData",
        "onCreate": "",
        "onOpen": "setActionHdsAnswerOnOpen",
        "onClose": "setActionHdsAnswerOnClose",
        "onDestroy": "SettingUserEntryPageonDestroy",
        "pageData": {},
        "extendPages": [
            {
                "subId": "SettingCIVersionInfoPage",
                "areas": ["EM", "EU","COL"],
                "subAreas": [],
                "country": [],
                "brand": [],
...
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        ...
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "VerpageOpenHandler1",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
    ...
    {
        "id": "setting_Upgrade_Progress_Page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/settingUpgradeProgressPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingUpgradeProgressPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "update progressing page",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "settingUpgradeProgressBtn",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            "aftEnterHandler": "settingUpgradeProgressOk"
        },
        "AutoClose": false,
        "AutoCloseTimeLength":30,
        "initData": "getSettingUpgradeProgressPageData",//页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "settingUpgradeProgressOnDestroy",  //页面创建时的回调函数
        "pageData": {},                          //此处节点可以为空，如果为空，则可利用导入Js文件中函数，在onCreate中进行赋值
        "keys": {
            "enable": [
                VK_ENTER
    ...
    {
        "id": "settingUpgradeDownloadingOkId",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingUpgradeDownloadingOk.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingUpgradeDownloadingOk.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/SettingUpgradeDownloadingOk.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "settingUpgradeDownloadingOk",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            "aftEscHandler": "settingUpgradeDownloadingEscHandle"
        },
        "AutoClose": false,
//            "AutoCloseTimeLength":30,
        "initData": "getSettingUpgradeDownloadingOkData",//页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "settingUpgradeDownloadingOkPageOnOpen",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "settingUpgradeDownloadingOnDestroy",  //页面创建时的回调函数
        "pageData": {},                          //此处节点可以为空，如果为空，则可利用导入Js文件中函数，在onCreate中进行赋值
        "keys": {
            "enable": [ VK_LEFT, VK_RIGHT, VK_ENTER, VK_BACK,VK_ESCAPE],
            "disable": []
    ...
    {
        "id": "setting_update_toast_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingUpdateToastPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingUpdateToastPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/SettingUpdateToastPage.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "default memory page",
        "AutoClose": false,
        "pageMode": "dialog",//可指定module,single,dialog
        "firstFocusId": "",//包括button或者Component
        "groupNavMode": "",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingUpdateToastPageData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "SettingUpdateToastPageDestory",                       //页面创建时的回调函数
        "pageData": {},
        "keys": {
            "enable": [VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT, VK_ENTER, VK_BACK],
            "disable": []
...
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
    ...
    {
        "id": "setting_usb_update_detect",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingUsbDetect.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingUsbDetect.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/channelScanSetStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "page",
        "AutoClose": false,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_usb_update_detect_text1",//包括button或者Component
        "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingUsbDetectData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "SettingUsbDetectOpen",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "SettingUsbDetectDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    {
        "id": "setting_chnl_ci",
...
/**************************new pic*********************/
...

    {
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "setting_snd_mode",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/setting/SA/SettingSndMode.js",
                "htmlPath": "UI/hisenseUI/modulePages/setting/SA/SettingSndMode.html"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "setting_snd_tv_speaker",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/setting/SA/SettingSndTvSpeaker.js",
                "htmlPath": "UI/hisenseUI/modulePages/setting/SA/SettingSndTvSpeaker.html"
            }
        ]
    },
    {
    ...
    {
        /**ModernTV Apply*/
        "id": "setting_snd_digital_audio",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingSndDigitalAudio.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingSndDigitalAudio.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/settingsnd.css",        //创建页面需要导入的css文件，由于回调问题，当前版本仅提供单一css文件
        "description": "settting DigitalAudio page",
        "pageMode": "module",//可指定module,single,dialog
        "AutoClose": true,
        "firstFocusId": "setting_snd_digital_audio_out_cmp",//包括button或者Component //todo
        "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingSndDigitalAudio", //页面创建前的回调函数    //todo
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "onSettingSndDigitalAudioOpen",      //页面创建时的回调函数    //todo
        "onClose": "",                        //页面关闭时的回调函数
        "onDestroy": "onSettingSndDigitalAudioDestroy",                       //页面销毁时的回调函数   //todo
        "pageData": {},
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "setting_snd_digital_audio",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/setting/SA/SettingSndDigitalAudio.js",
                "htmlPath": "UI/hisenseUI/modulePages/setting/SA/SettingSndDigitalAudio.html"
            }
        ]
    },
    {
        /**ModernTV Apply*/
        "id": "setting_snd_audio_out",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingSndAudioOut.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingSndAudioOut.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/settingsnd.css",        //创建页面需要导入的css文件，由于回调问题，当前版本仅提供单一css文件
        "description": "settting AudioOut page",
        "pageMode": "module",//可指定module,single,dialog
        "AutoClose": true,
        "firstFocusId": "setting_snd_audio_out_cmp",//包括button或者Component
        "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingSndAudioOutData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "onSettingSndAudioOutOpen",      //页面创建时的回调函数
        "onClose": "",                        //页面关闭时的回调函数
        "onDestroy": "onSettingSndAudioOutDestroy",                       //页面销毁时的回调函数
        "pageData": {}
    },
    {
        ...
        "pageMode": "module",
        "AutoClose": true,
        "firstFocusId": "setting_snd_balance_slider_cmp",//包括button或者Component
        "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "setting_snd_advanced_settings",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/setting/SA/SettingSndAdvanced.js",
                "htmlPath": "UI/hisenseUI/modulePages/setting/SA/SettingSndAdvanced.html"
            }
        ]
...
/*******************************setting Pic Start***************************/
    ...
    },
    {
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "SettingPicMode_New",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/setting/SA/SettingPicMode_New.js",
                "htmlPath": "UI/hisenseUI/modulePages/setting/SA/SettingPicMode_New.html"
            },
            {
                "subId": "SettingPicMode_New",
                "areas": ["EU"],//-运算符必须统一，以第一个为准
                ...
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/setting/EU/SettingPicMode_New.js",
                "htmlPath": "UI/hisenseUI/modulePages/setting/EU/SettingPicMode_New.html"
            }
        ]
//            "extendPages": [//多个页面都符合条件,用最后符合的
//                {
...
//            ]
    ...
    },
    {
        ...
        "description": "Mode sample page",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "setting_pic_advanced_display_cmp",
        "module": "setting",                         //表示页面所属模块
        "AutoClose": true,
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "setting_pic_advanced_page_new",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/setting/SA/SettingPicAdvanced_New.js",
                "htmlPath": "UI/hisenseUI/modulePages/setting/SA/SettingPicAdvanced_New.html"
//            },
//            {
//                "subId": "setting_pic_advanced_page_new",
//                "areas": ["EU"],//-运算符必须统一，以第一个为准
...
//                "country": [],
//                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
//                "jsPath": "modulePages/setting/EU/SettingPicAdvanced_New.js",
//                "htmlPath": "UI/hisenseUI/modulePages/setting/EU/SettingPicAdvanced_New.html"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "setting_pic_white_balance_2point_page",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/setting/SA/SettingPicWteBal2Pot.js",
                "htmlPath": "UI/hisenseUI/modulePages/setting/SA/SettingPicWteBal2Pot.html"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "setting_pic_white_balance_10point_page",
                "areas": ["SA"],//-运算符必须统一，以第一个为准
                "subAreas": [],
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/setting/SA/SettingPicWteBal10Pot.js",
                "htmlPath": "UI/hisenseUI/modulePages/setting/SA/SettingPicWteBal10Pot.html"
            }
        ]
    },
    {
    ...
    {
        "id": "setting_HotelLogo_UsbInput_page",
        "description": "Mode sample page",
        "pageMode": "module",
        "firstFocusId": "settingHotelLogoUsbInputDialogOk",
        "module": "hotel",
        "jsPath": "modulePages/setting/SettingHotelLogoUSbInputDialog.js",
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingHotelLogoUSbInputDialog.html",
        "cssPath": "",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getHotelLogoUsbInputDialogData",
        "onCreate": "",
        "onOpen": "settingHotelLogoUsbInputDialogOnOpen",
        "onClose": "settingHotelLogoUsbInputDialogOnClose",
        "onDestroy": "settingHotelLogoUsbInputDialogOnDestroy",
        "pageData": {},
        "handler": {
            "aftEscHandler": "settingHotelLogoUsbInputDialogEscHandle"
        },
        "keys": {
            "disable": []
        }
    ...
    {
        "id": "setting_HotelMode_UsbInput_dialog_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/SettingHotelModeUsbInputLogoDialog.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/SettingHotelModeUsbInputLogoDialog.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "Hotel mode UsbInpt dialog page",
        "AutoClose": true,
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "settingHotelModeUsbInputEnter",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getSettingHotelModeUsbInputDialogData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "settingHotelModeUsbInputPageOnOpen",                            //页面创建时的回调函数
        "onClose": "",                        //页面创建时的回调函数
        "onDestroy": "settingHotelModeUsbInputOnDestroy",                       //页面创建时的回调函数
        "pageData": {}
    },
    {
        "id": "setting_HotelUsbInput_List_Page",
        "description": "Hotel UsbInput List page",
        "pageMode": "module",
        "firstFocusId": "HotelUsbInputListContUl",
        "module": "setting",
        "jsPath": "modulePages/setting/settingHotelUsbInputList.js",
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingHotelUsbInputList.html",
        "cssPath": "",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getHotelUsbInputListData",
        "onCreate": "",
        "onOpen": "HotelUsbInputListOpenHandler",
        "onClose": "",
        "onDestroy": "",
        "pageData": {},
        "handler": {
            "aftEscHandler": "HotelUsbInputListEscHandler"
        },
        "keys": {
    ...
    {
        "id": "setting_HotelUsbInput_Logo_List_Page",
        "description": "Hotel UsbInput Logo List page",
        "pageMode": "module",
        "firstFocusId": "HotelUsbInputLogoListContUl",
        "module": "setting",
        "jsPath": "modulePages/setting/settingHotelUsbInputLogoList.js",
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingHotelUsbInputLogoList.html",
        "cssPath": "",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getHotelUsbInputLogoListData",
        "onCreate": "",
        "onOpen": "HotelUsbInputLogoListOpenHandler",
        "onClose": "",
        "onDestroy": "",
        "pageData": {},
        "handler": {
            "aftEscHandler": "HotelUsbInputLogoListEscHandler"
        },
        "keys": {
    ...
    {
        "id": "setting_HotelUsbInputLogoDialog_Page",
        "description": "Mode sample page",
        "pageMode": "module",
        "firstFocusId": "settingHotelUsbInputDialogInfo",
        "module": "setting",
        "jsPath": "modulePages/setting/settingHotelUsbInputLogoDialog.js",
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingHotelUsbInputLogoDialog.html",
        "cssPath": "",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getHotelUsbInputLogoDialogData",
        "onCreate": "",
        "onOpen": "DialogHotelUsbInputLogoOnOpen",
        "onClose": "",
        "onDestroy": "DialogHotelUsbInputLogoOnDestroy",
        "pageData": {},
        "handler": {
            "aftEscHandler": ""
        },
...
//            "AutoCloseTimeLength":30,
    ...
    {
        "id": "settingNetSetSwitchDialogId",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/setting/settingNetSetSwitchDialog.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingNetSetSwitchDialog.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
//            "cssPath": "css/wizardDialogStyle.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "setting network anyview stream dialog ",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "settingNetSetSwitch",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            "aftEscHandler": "settingNetSwitchDialogEscHandle"
        },
        "AutoClose": true,
//            "AutoCloseTimeLength":30,
        "initData": "getSettingNetSetSwitchDialogData",//页面创建前的回调函数
        "onCreate": "",                 //页面创建时的回调函数
        "onOpen": "",                            //页面创建时的回调函数
        "onClose": "",    //页面创建时的回调函数
        "onDestroy": "settingNetSetSwitchDialogOnDestroy",  //页面创建时的回调函数
        "pageData": {}                           //此处节点可以为空，如果为空，则可利用导入Js文件中函数，在onCreate中进行赋值
    },
    {
...
//            "AutoCloseTimeLength":30,
        ...
        "onCreate": "settingNetSetWifiSetPageOnCreate",                 //页面创建时的回调函数
...
//            "AutoCloseTimeLength":30,
        ...
        "onCreate": "settingNetSetEtherIpSetPageOnCreate",                 //页面创建时的回调函数
...
//            "AutoCloseTimeLength":30,
    ...
    {
        "id": "settingUserPreferencesPageId",
        "module": "setting",
        "jsPath": "modulePages/setting/settingUserPreferencesPageId.js",
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingUserPreferencesPageId.html",
        "description": "version info list",
        "pageMode": "module",
        "firstFocusId": "settingUserPreferencesListUl",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            "aftEscHandler": "settingVersionInfoListDialogEscHandle"
        },
        "AutoClose": false,
        //"AutoCloseTimeLength":30,
        "initData": "getSettingUserPreferencesPageData",
        "onCreate": "",
        "onOpen": "",
        "onClose": "",
        "onDestroy": "settingVersionInfoListDialogOnDestroy",
        "pageData": {}
    },
    {
        ...
        {
        "id": "settingChSetATVFineTuningId",
        "module": "setting",
        "jsPath": "modulePages/setting/settingChSetATVFineTuning.js",
        "htmlPath": "UI/hisenseUI/modulePages/setting/settingChSetATVFineTuning.html",
        "cssPath": "css/wizardDialogStyle.css",
        "description": "setting ATV Fine Tuning dialog ",
        "pageMode": "module",
        "firstFocusId": "settingChSetATVTuningPlus",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "AutoClose": true,
        //"AutoCloseTimeLength":30,
        "handler": {
            "aftEscHandler": "settingChSetATVFineTuningEscHandle"
        },
        "initData": "getSettingChSetATVFineTuningData",
        "onCreate": "",
        "onOpen": "settingChSetATVFineTuningDialogonOpen",
        "onClose": "settingChSetATVFineTuningOnClose",
        "onDestroy": "settingChSetATVFineTuningOnDestroy",
        "pageData": {}
    },
    {
...
//            "AutoCloseTimeLength":30,
        ...
        "keys":{
//            "enable":[VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT, VK_ENTER, VK_BACK]
            "disable":[VK_NETFLIX,VK_YOUTUBE, VK_VUDU,VK_FOOTBAL,VK_CINEMA]
        },
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
...
//                    "cssPath": ""
            ...
            },
            {
                ...
                "country": [],
                "brand": [],   //空值为All，“-”表示排除，，以第一个为准
                "jsPath": "modulePages/channelManager/SA/channelmanager_fav.js",
                "htmlPath": "UI/hisenseUI/modulePages/channelManager/SA/channelmanager_fav.html",
//                    "cssPath": ""
                "handler": {
                    befEscHandler: "channelmanagerfav.returnManagerPage"
                }
...
//            "groupNavMode": "nearest",//nearest,sequence
    ...
    // 5659 EU channel edit
    {
        "id": "channel_edit_choose_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/channelManager/EU/ChSetChooseListPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/channelManager/EU/ChSetChooseListPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/channelmanager.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "channel manager page ",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "chl_choose_list",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        ...
        "AutoClose": true,
        "initData": "getChooseListPageData",//页面创建前的回调函数
        "onCreate": "",                 //页面创建时的回调函数
        "onOpen": "ChannelEditChoosePage.onOpenChlManager",                            //页面创建时的回调函数
        "onClose": "",    //页面创建时的回调函数
        "onDestroy": "ChannelEditChoosePage.onDestroyPage",  //页面创建时的回调函数
        "pageData": {},                           //此处节点可以为空，如果为空，则可利用导入Js文件中函数，在onCreate中进行赋值
        "extendPages": []
    },
    {
        "id": "channel_edit_all_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/channelManager/EU/ChEditAllPage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/channelManager/EU/ChEditAllPage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/ChannelEditPage.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "channel manager backgroud ",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "chl_manager_list_all",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            befEscHandler: "ChannelEditAllPage.returnManagerPage"
        },
        "AutoClose": true,
        "initData": "getchlmanagerAllData",//页面创建前的回调函数
        "onCreate": "",                 //页面创建时的回调函数
        "onOpen": "ChannelEditAllPage.onOpenChlManagerAll",                            //页面创建时的回调函数
        "onClose": "",    //页面创建时的回调函数
        "onDestroy": "ChannelEditAllPage.onDestroyPage",  //页面创建时的回调函数
        "pageData": {}                           //此处节点可以为空，如果为空，则可利用导入Js文件中函数，在onCreate中进行赋值
    },
    {
        "id": "channel_edit_delete_page",
        "module": "setting",                         //表示页面所属模块
        "jsPath": "modulePages/channelManager/EU/ChEditDeletePage.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "UI/hisenseUI/modulePages/channelManager/EU/ChEditDeletePage.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": "css/ChannelEditPage.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "description": "channel manager backgroud ",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "chl_manager_list_delete",//包括button或者Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(最近原则)，sequence(正序原则)，
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            befEscHandler: "ChannelEditDeletePage.returnManagerPage"
        },
        "AutoClose": true,
        "initData": "getchlmanagerDeleteData",//页面创建前的回调函数
        "onCreate": "",                 //页面创建时的回调函数
        "onOpen": "ChannelEditDeletePage.onOpenChlManagerDelete",                            //页面创建时的回调函数
        "onClose": "",    //页面创建时的回调函数
        "onDestroy": "ChannelEditDeletePage.onDestroyPage",  //页面创建时的回调函数
        "pageData": {}                           //此处节点可以为空，如果为空，则可利用导入Js文件中函数，在onCreate中进行赋值
    },
...
//            "cssPath": "css/channelCommon.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
    ...
    },
    {
        ...
        "pageData": {},
        "handler": {
            "aftEscHandler": "MixbarEscHandler"

        }
    },
    {
        "id": "NoblexLauncher_page",
        "description": "Mode sample page",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "NoblexLauncherUl1",
        "module": "launcher",                         //表示页面所属模块
        "AutoClose": false,
        "AutoCloseTimeLength": 5,
        "jsPath": VIDAAU2LauncherBaseDir + "js/NoblexLauncher.js",          //导入Js文件,由于回调问题，当前版本仅提供单一js文件
        "htmlPath": "VIDAAU2Launcher/html/NoblexLauncher.html",      //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "cssPath": VIDAAU2LauncherBaseDir + "css/NoblexLauncher.css",        //创建页面需要导入的HTML文件，由于回调问题，当前版本仅提供单一html文件
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "initData": "getNoblexLauncherPageData", //页面创建前的回调函数
        "onCreate": "",                        //页面创建时的回调函数
        "onOpen": "NoblexLauncherOnOpen",
        "onFocus":"NoblexLauncherOnFocus",
        "onClose": "NoblexLauncherOnClose",                        //页面创建时的回调函数
        "onDestroy": "NoblexLauncherOnDestory",                       //页面创建时的回调函数
        "pageData": {},
        "handler": {
            "befDownHandler": "NoblexLauncherkeydownhander",
            "befUpHandler":"NoblexLauncherkeyuphander",
            "befLeftHandler": "NoblexLauncherkeylefthander",
            "befRightHandler":"NoblexLauncherkeyrighthander",
            "befEnterHandler":"NoblexLauncherkeyenterhander",
            "aftEscHandler":"NoblexLauncherkeybackhander"
        }
//        "keys": {
//            "enable": [
////                VK_UP,VK_DOWN,VK_LEFT,VK_RIGHT,VK_ENTER,VK_BACK,VK_BACK_SPACE,VK_ESCAPE
//            ],
//            "disable":[
//            ]
//        }
...
//                        {"mode":"scale","param":[0.1,0.1,'15%','50%'],"speed":"slow"}//初始x大小，y大小，原始参考点
        ...
        "handler": {
            ...
            keyNum6Handler: "setDefaultDataStatus",
            keyNum9Handler: "setDefaultDataStatus",
            keyNum0Handler: "setDebugDataStatus",
            keyNum5Handler: "setDebugDataStatus",
            keyNum3Handler: "setDebugDataStatus",
            keyNum2Handler: "setDebugDataStatus"
        },
        "AutoClose": false,
...
//            "groupNavMode": "nearest",//nearest,sequence
    ...
    },
    {
        ...
        "description": "launcher",
        "pageMode": "module",//可指定module,single,dialog
        "firstFocusId": "launcherLiveTv_no_signal_item_Ul",//包括button或�?�Component
//            "groupNavMode": "nearest",//nearest,sequence
        //导航进入到数组按钮的方式：nearby(�?近原�?)，sequence(正序原则)�?
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
    ...
    //U2 launcher
    {
        "id": "ViddaU2ResetLauncherEditId",
        "module": "launcher",
        "jsPath": "modulePages/dialog/ViddaU2ResetLauncherEdit.js",
        "htmlPath": "UI/hisenseUI/modulePages/dialog/ViddaU2ResetLauncherEdit.html",
        "cssPath": "",
        "description": "reset ",
        "pageMode": "module",
        "firstFocusId": "VidaaU2ResetLaucherEditCancel",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "handler": {
            "aftEscHandler": "VidaaU2ResetLaucherEditEscHandle"
        },
        "AutoClose": false,
        "initData": "getVidaaU2ResetLaucherEditData",
        "onCreate": "",
        "onOpen": "",
        "onClose": "",
        "onFocus": "",
        "onBlur": "",
        "onDestroy": "VidaaU2ResetLaucherEditOnDestroy",
        "pageData": {},
        "keys": {
            "enable": [
                VK_LEFT, VK_RIGHT, VK_UP, VK_DOWN, VK_ENTER, VK_BACK,
    ...
    {
        "id": "VIDAAU2MainTitlePage",
        "module": "launcher",
        "jsPath": VIDAAU2LauncherBaseDir + "js/VIDAAU2MainTitle.js",
        "htmlPath":"VIDAAU2Launcher/html/VIDAAU2MainTitle.html",
        "cssPath": VIDAAU2LauncherBaseDir + "css/VIDAAU2MainTitle.css",
        "description": "",
        "pageMode": "module",
        "firstFocusId": "VidaaU2MainTitleList",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "AutoClose": false,
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                ...
                "firstFocusId": "",
                //以上三项配置必须完全符合
                "brand": ['dev','pan','riv','kal','fam','blu','avi','ezy','ame','cha','adm','jvc','pio'],   //空值为All，“-”表示排除，，以第一个为准
                "cssPath": VIDAAU2LauncherBaseDir + "css/OEM/VIDAAU2MainTitle.css"
            },
            {
                "subId": "",
                "areas": ['SA'],
                ...
                "cssPath": VIDAAU2LauncherBaseDir + "css/VIDAAU2MainTitleBGH.css"
            }
        ],
        "handler": {
            keyNum1Handler: "setDefaultDataStatus",
            ...
            keyNum3Handler: "setDebugDataStatus",
            keyNum2Handler: "setDebugDataStatus",
            "aftEscHandler":"VIDAAU2MainTitleEscHandler"
        },
        "initData": "getVIDAAU2MainTitlePageData",
        "onCreate": "VIDAAU2MainTitleOnCreate",
        "onOpen": "VIDAAU2MainTitleOnOpen",
        "onClose": "VIDAAU2MainTitleOnClose",
        "onFocus": "VIDAAU2MainTitleOnFocus",
        "onDestroy": "VIDAAU2MainTitleOnDestroy",
        "pageData": {}
    },
    {
        "id": "VIDAAU2StatusPage",
        "module": "launcher",
        "jsPath": VIDAAU2LauncherBaseDir + "js/VIAAU2StatusBar.js",
        "htmlPath":"VIDAAU2Launcher/html/VIAAU2StatusBar.html",
        "cssPath": VIDAAU2LauncherBaseDir + "css/VIAAU2StatusBar.css",
        "description": "",
        "pageMode": "module",
        "firstFocusId": "VidaaU2MainTitleList",
        "horizontalEdgesJump": false,
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的

            {
                ...
                //以上三项配置必须完全符合
                "brand": ['bgh'],   //空值为All，“-”表示排除，，以第一个为准
                "cssPath": VIDAAU2LauncherBaseDir + "css/VIAAU2StatusBarBGH.css"
            }
        ],
        "initData": "getVIDAAU2StatusPageData",
        "onCreate": "",
        "onOpen": "VIDAAU2StatusOnOpen",
        "onClose": "VIDAAU2StatusOnClose",
        "pageData": {}
    },
    {
        "id": "VIDAAU2TvInput",
        "module": "launcher",
        "jsPath": VIDAAU2LauncherBaseDir + "js/VIDAAU2TvInput.js",
        "htmlPath":"VIDAAU2Launcher/html/VIDAAU2TvInput.html",
        "cssPath": VIDAAU2LauncherBaseDir + "css/VIDAAU2TvInput.css",
        "description": "",
        "pageMode": "module",
        "firstFocusId": "VIDAAU2TvInputUl",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "autoLocation":{
            "layer":"VIDAAU2TvInputUl",//自动平移的div id注册
            "width":1150,//显示范围宽度
            "edgeWidthL":0,//边界宽度
            "edgeWidthR":30,//边界宽度
            "left":0//边界宽度
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                "subId": "VIDAAU2TvInput",
                "areas": ['SA'],
                "subAreas": [],
                "country": [],
                "firstFocusId": "",
                //以上三项配置必须完全符合
                "brand": ['dev','pan','riv','kal','fam','blu','avi','ezy','ame','cha','adm'],//空值为All，“-”表示排除，，以第一个为准
                "jsPath": VIDAAU2LauncherBaseDir + "js/OEM/VIDAAU2TvInput.js",
                "htmlPath":"VIDAAU2Launcher/html/OEM/VIDAAU2TvInput.html",
                "cssPath": VIDAAU2LauncherBaseDir + "css/OEM/VIDAAU2TvInput.css"
            }
        ],
        //"AutoCloseTimeLength":30,
        "handler": {
            befEscHandler : "VIDAAU2TvInputEscHandler"
        },
        "initData": "getVIDAAU2TvInputPageData",
        "onCreate": "",
        "onOpen": "VIDAAU2TvInputOnOpen",
        "onClose": "VIDAAU2TvInputOnClose",
        "onDestroy": "VIDAAU2TvInputDestroy",
        "pageData": {}
    },
    {
        "id": "VIDAAU2AppPage",
        "module": "launcher",
        "jsPath": VIDAAU2LauncherBaseDir + "js/VIDAAU2AppPage.js",
        "htmlPath":"VIDAAU2Launcher/html/VIDAAU2AppPage.html",
        "cssPath": VIDAAU2LauncherBaseDir + "css/VIDAAU2AppPage.css",
        "description": "",
        "pageMode": "module",
        "firstFocusId": "VIDAAU2AppPageUl",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "autoLocation":{
            "layer":"VIDAAU2AppPageUlContent",//自动平移的div id注册
            "width":1150,//显示范围宽度
            "edgeWidthL":0,//边界宽度
            "edgeWidthR":30,//边界宽度
            "left":0//边界宽度
        ...
        "extendPages": [//多个页面都符合条件,用最后符合的
            {
                ...
                //以上三项配置必须完全符合
                "brand": ['dev','pan','riv','kal','fam','blu','avi','ezy','ame','cha','adm'],//空值为All，“-”表示排除，，以第一个为准
                "jsPath": VIDAAU2LauncherBaseDir + "js/OEM/VIDAAU2AppPage.js",
                "htmlPath":"VIDAAU2Launcher/html/OEM/VIDAAU2AppPage.html",
                "cssPath": VIDAAU2LauncherBaseDir + "css/OEM/VIDAAU2AppPage.css"
            }
        ],
        "handler": {
            befEscHandler : "VIDAAU2AppPageEscHandler"
        },
        "initData": "getVIDAAU2AppPageData",
        "onCreate": "",
        "onOpen": "VIDAAU2AppPageOnOpen",
        "onClose": "VIDAAU2AppPageOnClose",
        "onDestroy": "VIDAAU2AppPageDestroy",
        "pageData": {}
    },
    {
        "id": "VIDAAU2NobAppPage",
        "module": "launcher",
        "jsPath": VIDAAU2LauncherBaseDir + "js/VIDAAU2NobAppPage.js",
        "htmlPath":"VIDAAU2Launcher/html/VIDAAU2NobAppPage.html",
        "cssPath": VIDAAU2LauncherBaseDir + "css/VIDAAU2NobAppPage.css",
        "description": "",
        "pageMode": "module",
        "firstFocusId": "VIDAAU2AppPageUl",
        "horizontalEdgesJump": false,
    ...
    },
    {
        "id": "notification",
        "module": "launcher",
        "jsPath": VIDAAU2LauncherBaseDir + "js/notification.js",
        "htmlPath":"VIDAAU2Launcher/html/notification.html",
        "cssPath": VIDAAU2LauncherBaseDir + "css/notification.css",
        "description": "",
        "pageMode": "module",
        "firstFocusId": "notificationUl",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "AutoClose": false,
        //"AutoCloseTimeLength":30,
        "handler": {
            befEscHandler : "VIDAAU2NotificationEscHandler"
        },
        "initData": "getNotificationPageData",
        "onCreate": "",
        "onOpen": "notificationOnOpen",
        "onClose": "notificationOnClose",
        "onDestroy": "notificationOnDestroy",
        "pageData": {}
    },
    {
        "id": "pictureResourceA",
        "module": "launcher",
        "jsPath": VIDAAU2LauncherBaseDir + "js/pictureResourceA.js",
        "htmlPath":"VIDAAU2Launcher/html/pictureResourceA.html",
        "cssPath": VIDAAU2LauncherBaseDir + "css/pictureResourceA.css",
        "description": "",
        "pageMode": "module",
        "firstFocusId": "pictureResourceA_focus",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "AutoClose": false,
        //"AutoCloseTimeLength":30,
        "handler": {
            befEscHandler : "PictureResourceAEscHandler"
        },
        "initData": "getPictureResourceAPageData",
        "onCreate": "",
        "onOpen": "PictureResourceAOnOpen",
        "onClose": "",
        "onDestroy": "PictureResourceAOnDestroy",
        "pageData": {}
    },
    {
        "id": "pictureResourceB",
        "module": "launcher",
        "jsPath": VIDAAU2LauncherBaseDir + "js/pictureResourceB.js",
        "htmlPath":"VIDAAU2Launcher/html/pictureResourceB.html",
        "cssPath": VIDAAU2LauncherBaseDir + "css/pictureResourceB.css",
        "description": "",
        "pageMode": "module",
        "firstFocusId": "pictureResourceB_focus",
        "horizontalEdgesJump": false,
        "verticalEdgesJump": true,
        "CaE": [],
        "AutoClose": false,
        //"AutoCloseTimeLength":30,
        "handler": {
            befEscHandler : "PictureResourceBEscHandler"
        },
        "initData": "getPictureResourceBPageData",
        "onCreate": "",
        "onOpen": "PictureResourceBOnOpen",
        "onClose": "",
        "onDestroy": "PictureResourceBOnDestroy",
        "pageData": {}
    },
    {
        "id": "DLNAMessage",
        "module": "DLNAMessage",
        "jsPath": "modulePages/dialog/DLNAMessage.js",
        "htmlPath":"UI/hisenseUI/modulePages/dialog/DLNAMessage.html",
        "cssPath": "css/DLNAMessage.css",
        "description": "",
        "pageMode": "module",
        "firstFocusId": "",
        "horizontalEdgesJump": false,
        ...
        //"AutoCloseTimeLength":30,
        "handler": {
            befEscHandler : "DLNAMessageEscHandler"
        },
        "initData": "getDLNAMessagePageData",
        "onCreate": "",
        "onOpen": "DLNAMessageOnOpen",
        "onClose": "",
        "onDestroy": "DLNAMessageOnDestroy",
        "pageData": {}
    }
