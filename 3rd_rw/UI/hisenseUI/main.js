...
function parseLocalTime() {
    ...
    DBG_INFO(objToString(localTime) + "; " + GLOBAL.TIME_FORMAT);
    ...
    var formatHour = getHourByFormat(localTime[3], GLOBAL.TIME_FORMAT);
...
function repeatModeToRepeatStr(repeatMode) {
    ...
    var repeatStr = 'Once';
    var mode = parseInt(repeatMode);
    if (mode == 0) {
        repeatStr = 'Everyday';
    } else if (mode == 128) {
        repeatStr = 'Once';
    } else if (mode > 0 && mode < 128) {
        repeatStr = 'Weekly';
    }
    return repeatStr;
}
...
function showTVTip(content, timeOut, callBack) {
    ...
    $('#tv_tips_content_2').css('display', 'none');


    tvTipTimer = setTimeout(function () {
        $('#tv_tips_osd').css('width', 400 +"px");
        $('#tv_tips_content').css('width', 400 +"px");
...
function showTVPictureTip(content1,content2,timeOut,callBack){
    if (!!tvTipTimer) {
        clearTimeout(tvTipTimer);
    }
    timeOut = !timeOut ? 3 : timeOut;

    $('#tv_tips_content').html(getCurrentContentLanguage(content1));
    $('#tv_tips_content_2').html(getCurrentContentLanguage(content2));
    $('#tv_tips_bkg').css('display', 'block');

    tvTipTimer = setTimeout(function () {
        $('#tv_tips_bkg').css('display', 'none');
        $('#tv_tips_osd').css('width', 400 +"px");
        $('#tv_tips_osd').css('height', 120 +"px");
        $('#tv_tips_osd').css('margin-top', 900 +"px");

        $('#tv_tips_content').html('');
        $('#tv_tips_content').css('width', 400 +"px");
        $('#tv_tips_content_2').html('');
        $('#tv_tips_content_2').css('display', 'none');
...
var fileDataTemp = {}
var accuweatherTempData = {
    defInd: 1,
    cityList: [
        {
            locId: '15-349727_1_AL',
            locName: 'New York',
        ...
        },
        {
            ...
            "locCountry": "Buenos Aires - Capital Federal",
            "unit": "Imperial",
            "timeZone": -3
        }
    ]
...
var dataTemp = {
    "15-349727_1_AL": {
        current: [
            {
                "LocalObservationDateTime": "2014-09-16T01:03:00-04:00",
                "EpochTime": 1410843780,
                ...
                "DewPoint": {
                    ...
                    "Imperial": {"Value": 52.0, "Unit": "F", "UnitType": 18}
                },
                "Wind": {
                    "Direction": {"Degrees": 0, "Localized": "N", "English": "N"},
                    "Speed": {
                        "Metric": {"Value": 0.0, "Unit": "km/h", "UnitType": 7},
                        "Imperial": {"Value": 0.0, "Unit": "mi/h", "UnitType": 9}
                    }
                },
                "WindGust": {
                    "Speed": {
                ...
                "CloudCover": 60,
                "Ceiling": {
                    "Metric": {"Value": 11765.0, "Unit": "m", "UnitType": 5},
                    "Imperial": {"Value": 38600.0, "Unit": "ft", "UnitType": 0}
                },
                "Pressure": {
                    "Metric": {"Value": 1018.1, "Unit": "mb", "UnitType": 14},
                    "Imperial": {"Value": 30.06, "Unit": "inHg", "UnitType": 12}
                },
                ...
                "TemperatureSummary": {
                    ...
                    "Past12HourRange": {
                        "Minimum": {
                            "Metric": {"Value": 16.3, "Unit": "C", "UnitType": 17},
                            "Imperial": {"Value": 61.0, "Unit": "F", "UnitType": 18}
                        },
                        "Maximum": {
                            "Metric": {"Value": 21.7, "Unit": "C", "UnitType": 17},
                ...
                "MobileLink": "http://m.accuweather.com/en/us/new-york-ny/10007/current-weather/15-349727_1_al?lang=en-us",
                "Link": "http://www.accuweather.com/en/us/new-york-ny/10007/current-weather/15-349727_1_al?lang=en-us"
            }
        ],
        forecast: {
            "Headline": {
                "EffectiveDate": "2014-09-20T08:00:00-04:00",
                "EffectiveEpochDate": 1411214400,
                "Severity": 4,
                "Text": "Pleasant Saturday",
                "Category": null,
                "EndDate": null,
                "EndEpochDate": null,
                "MobileLink": "http://m.accuweather.com/en/us/new-york-ny/10007/extended-weather-forecast/15-349727_1_al?lang=en-us",
                "Link": "http://www.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?lang=en-us"
            }, "DailyForecasts": [
                {
                    "Date": "2014-09-15T07:00:00-04:00",
                    "EpochDate": 1410778800,
                    "Temperature": {
                        "Minimum": {"Value": 60.0, "Unit": "F", "UnitType": 18},
                        "Maximum": {"Value": 71.0, "Unit": "F", "UnitType": 18}
                    },
                    "Day": {"Icon": 1, "IconPhrase": "Sunny"},
                    "Night": {"Icon": 40, "IconPhrase": "Mostly cloudy w/ showers"},
                    "Sources": ["AccuWeather"],
                    "MobileLink": "http://m.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?lang=en-us",
                    "Link": "http://www.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?lang=en-us"
                },
                {
                    "Date": "2014-09-16T07:00:00-04:00",
                    "EpochDate": 1410865200,
                    "Temperature": {
                        "Minimum": {"Value": 56.0, "Unit": "F", "UnitType": 18},
                        "Maximum": {"Value": 73.0, "Unit": "F", "UnitType": 18}
                    },
                    "Day": {"Icon": 13, "IconPhrase": "Mostly cloudy w/ showers"},
                    "Night": {"Icon": 33, "IconPhrase": "Clear"},
                    "Sources": ["AccuWeather"],
                    "MobileLink": "http://m.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?day=1&lang=en-us",
                    "Link": "http://www.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?day=1&lang=en-us"
                },
                {
                    "Date": "2014-09-17T07:00:00-04:00",
                    "EpochDate": 1410951600,
                    "Temperature": {
                    ...
                    "Night": {"Icon": 33, "IconPhrase": "Clear"},
                    "Sources": ["AccuWeather"],
                    "MobileLink": "http://m.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?day=2&lang=en-us",
                    "Link": "http://www.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?day=2&lang=en-us"
                },
                {
                    "Date": "2014-09-18T07:00:00-04:00",
                    "EpochDate": 1411038000,
                    "Temperature": {
                        "Minimum": {"Value": 54.0, "Unit": "F", "UnitType": 18},
                        "Maximum": {"Value": 74.0, "Unit": "F", "UnitType": 18}
                    },
                    "Day": {"Icon": 3, "IconPhrase": "Partly sunny"},
                    "Night": {"Icon": 35, "IconPhrase": "Partly cloudy"},
                    "Sources": ["AccuWeather"],
                    "MobileLink": "http://m.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?day=3&lang=en-us",
                    "Link": "http://www.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?day=3&lang=en-us"
                },
                {
                    "Date": "2014-09-19T07:00:00-04:00",
                    "EpochDate": 1411124400,
                    "Temperature": {
                        "Minimum": {"Value": 55.0, "Unit": "F", "UnitType": 18},
                        "Maximum": {"Value": 68.0, "Unit": "F", "UnitType": 18}
                    },
                    "Day": {"Icon": 3, "IconPhrase": "Partly sunny"},
                    "Night": {"Icon": 36, "IconPhrase": "Intermittent clouds"},
                    "Sources": ["AccuWeather"],
                    "MobileLink": "http://m.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?day=4&lang=en-us",
                    "Link": "http://www.accuweather.com/en/us/new-york-ny/10007/daily-weather-forecast/15-349727_1_al?day=4&lang=en-us"
                }
            ]
        }
    },
    "7894":{
        current: [{
            "LocalObservationDateTime": "2015-04-11T03:35:00-03:00",
            "EpochTime": 1428734100,
            "WeatherText": "Cloudy",
            "WeatherIcon": 7,
            "IsDayTime": false,
            "Temperature": {
                "Metric": {"Value": 20, "Unit": "C", "UnitType": 17},
                "Imperial": {"Value": 68, "Unit": "F", "UnitType": 18}
            },
            "RealFeelTemperature": {
                "Metric": {"Value": 18.5, "Unit": "C", "UnitType": 17},
                "Imperial": {"Value": 65, "Unit": "F", "UnitType": 18}
            },
            "RealFeelTemperatureShade": {
                "Metric": {"Value": 18.5, "Unit": "C", "UnitType": 17},
                "Imperial": {"Value": 65, "Unit": "F", "UnitType": 18}
            ...
            "DewPoint": {
                ...
                "Imperial": {"Value": 64, "Unit": "F", "UnitType": 18}
            },
            "Wind": {
                "Direction": {"Degrees": 113, "Localized": "ESE", "English": "ESE"},
                "Speed": {
            ...
            "CloudCover": 95,
            "Ceiling": {
                "Metric": {"Value": 9144, "Unit": "m", "UnitType": 5},
                "Imperial": {"Value": 30000, "Unit": "ft", "UnitType": 0}
            },
            "Pressure": {
                "Metric": {"Value": 1017, "Unit": "mb", "UnitType": 14},
            ...
            "WetBulbTemperature": {
                "Metric": {"Value": 18.6, "Unit": "C", "UnitType": 17},
                "Imperial": {"Value": 65, "Unit": "F", "UnitType": 18}
            },
            "Precip1hr": {
            ...
            "TemperatureSummary": {
                ...
                "Past24HourRange": {
                    "Minimum": {
                        "Metric": {"Value": 19.2, "Unit": "C", "UnitType": 17},
                        "Imperial": {"Value": 66, "Unit": "F", "UnitType": 18}
                    },
                    "Maximum": {
            ...
            "MobileLink": "http://m.accuweather.com/en/ar/buenos-aires/7894/current-weather/7894",
            "Link": "http://www.accuweather.com/en/ar/buenos-aires/7894/current-weather/7894"
        }],
        forecast: {
            "Headline": {
                "EffectiveDate": "2015-04-12T07:00:00-03:00",
                "EffectiveEpochDate": 1428832800,
                "Severity": 4,
                "Text": "Pleasant tomorrow",
                "Category": null,
                "EndDate": null,
                "EndEpochDate": null,
                "MobileLink": "http://m.accuweather.com/en/ar/buenos-aires/7894/extended-weather-forecast/7894",
                "Link": "http://www.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894"
            },
            "DailyForecasts": [{
                "Date": "2015-04-10T07:00:00-03:00",
                "EpochDate": 1428660000,
                "Temperature": {
                    "Minimum": {"Value": 64, "Unit": "F", "UnitType": 18},
                    "Maximum": {"Value": 82, "Unit": "F", "UnitType": 18}
                },
                "Day": {"Icon": 2, "IconPhrase": "Mostly sunny"},
                "Night": {"Icon": 39, "IconPhrase": "Partly cloudy w/ showers"},
                "Sources": ["AccuWeather"],
                "MobileLink": "http://m.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894",
                "Link": "http://www.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894"
            }, {
                "Date": "2015-04-11T07:00:00-03:00",
                "EpochDate": 1428746400,
                "Temperature": {
                    "Minimum": {"Value": 62, "Unit": "F", "UnitType": 18},
                    "Maximum": {"Value": 72, "Unit": "F", "UnitType": 18}
                },
                "Day": {"Icon": 4, "IconPhrase": "Intermittent clouds"},
                "Night": {"Icon": 36, "IconPhrase": "Intermittent clouds"},
                "Sources": ["AccuWeather"],
                "MobileLink": "http://m.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894?day=1",
                "Link": "http://www.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894?day=1"
            }, {
                "Date": "2015-04-12T07:00:00-03:00",
                "EpochDate": 1428832800,
                "Temperature": {
                    "Minimum": {"Value": 67, "Unit": "F", "UnitType": 18},
                    "Maximum": {"Value": 75, "Unit": "F", "UnitType": 18}
                },
                "Day": {"Icon": 3, "IconPhrase": "Partly sunny"},
                "Night": {"Icon": 35, "IconPhrase": "Partly cloudy"},
                "Sources": ["AccuWeather"],
                "MobileLink": "http://m.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894?day=2",
                "Link": "http://www.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894?day=2"
            }, {
                "Date": "2015-04-13T07:00:00-03:00",
                "EpochDate": 1428919200,
                "Temperature": {
                    "Minimum": {"Value": 66, "Unit": "F", "UnitType": 18},
                    "Maximum": {"Value": 79, "Unit": "F", "UnitType": 18}
                },
                "Day": {"Icon": 2, "IconPhrase": "Mostly sunny"},
                "Night": {"Icon": 35, "IconPhrase": "Partly cloudy"},
                "Sources": ["AccuWeather"],
                "MobileLink": "http://m.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894?day=3",
                "Link": "http://www.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894?day=3"
            }, {
                "Date": "2015-04-14T07:00:00-03:00",
                "EpochDate": 1429005600,
                "Temperature": {
                    "Minimum": {"Value": 63, "Unit": "F", "UnitType": 18},
                    "Maximum": {"Value": 78, "Unit": "F", "UnitType": 18}
                },
                "Day": {"Icon": 4, "IconPhrase": "Intermittent clouds"},
                "Night": {"Icon": 12, "IconPhrase": "Showers"},
                "Sources": ["AccuWeather"],
                "MobileLink": "http://m.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894?day=4",
                "Link": "http://www.accuweather.com/en/ar/buenos-aires/7894/daily-weather-forecast/7894?day=4"
            }]
        }
    }
}
...
function startHiPageApp(command, storeType) {
    ...
    if (command == 'setting_pic_Mira_page') {
        hiWebOsFrame.createPage('setting_pic_Mira_page', null, null, null, function (a) {
            ...
            if (g_launcherBrand == "SA_OEM" || g_launcherBrand == "VIDAALite" || g_launcherBrand == "VIDAALiteU2") {
                if (!canProcessVolume()) {
...
function sendCommndToTV(cmdType, command, setRunTimes, storeType) {
    ...
    if ("accuweather" == command) {
        cmdType =  CmdURLType.START_NATIVEAPP;
    }
    switch (cmdType) {
...
//                    }
                    ...
                    else if(command.toLowerCase()=='emanual' || command.indexOf("Local_ebook/index.html") > -1)
                    {
                        var lan = hiWebOsFrame.getCurrentLanguage();
                        var lanUrl = HSAPPURL.DIANZISHU;
                        var lanManualList = ["eng","spa"];
                        var idx = $.inArray(lan,lanManualList);
                        if(idx>-1){
                            lanUrl = "file:///3rd_rw/appdata/Local_ebook/Ebook_"+lan+"/index.html";
                        }
                        asyncStartApp("app_tv_store", lanUrl, false, false, false, false, StoreType.HISENSE);
                    }else if(command =='file:///3rd_rw/UI/hisenseUI/modulePages/setting/SA/OpenSource.html'){
                        asyncStartApp("app_tv_store",'file:///3rd_rw/UI/hisenseUI/modulePages/setting/SA/OpenSource.html', false, false, false, false, StoreType.HISENSE);
                    }
                    else {
        ...
        case CmdURLType.START_WEBAPP:
            ...
            }else if(!!command && "file:///3rd_rw/UI/hisenseUI/modulePages/setting/SA/OpenSource.html" == command){
        ...
        case CmdURLType.START_HBBTV_APP:
            ...
            deviceKeySet.HBBTVPAUSED = false;   //maybe auto resume by hbbtv app, so just reset deviceKeySet.HBBTVPAUSED to false
            ...
            setTimeout(function () {
                ...
                sendAM(":am,opera4x,hbbtv:open=" + command);
            }, 1000);
            break;
...
//这部分定义与launcherDataInterface.js中的定义合并
//function CmdURLType() {
//
//}
//CmdURLType.NONE = 0;
...
HSAPPURL.DAILYMOTION = "http://tvsam-02.ext.dc3.dailymotion.com/live/?manufacturer=hisense";
...
HSAPPURL.DIANZISHU = "file:///3rd_rw/appdata/Local_ebook/Ebook_eng/index.html";
...
//    "file://3rd_rw/terratv/terratv.html": "terratv",
    ...
    "file:///3rd_rw/appdata/Local_ebook/index.html":"emanual"
}
...
function resumeDTV() {
    ...
    if (GLOBAL.WAIT_POWERON || GLOBAL.TV_SUSPENDING) {
        DBG_ERROR("TV_SUSPENDING now ,return");
        return;
    }
...
function showLoadingOrLockKey(pageId, isStart) {
    ...
    if (pageId != "app_tv_store") {
        if (!startEUXT910EPOS) {
            //openBlackScreen();
            //$('#sdkLoading').css('display', 'block');
            DBG_INFO("showLoadingOrLockKey   " + pageId);
            if (pageId != "app_netflix" && pageId != "app_lau_browser") {
...
//    }
    ...
    try {
        ...
        hiWebOsFrame.createPage(pageId, null, crntPage, null, function (a) {
            ...
            a.operateData.logParam = getLogReportParam(command, pageId, null == crntPage ? "" : crntPage.module, isRemoteKey, storeType, isStandby, null == crntPage ? "" : crntPage.id,isDialserver);
            debugRM("!!!!!!!!!!!!!!!!!!!!!!!" + storeType);
...
function asyncStopApp(pageId, origin, commandType) {
    try {
        ...
        if(!!hiWebOsFrame[pageId]&&(!!hiWebOsFrame[pageId].operateData)){
            ...
            if(pageId=="app_netflix"&&commandType==CmdURLType.STOP_FROM_DIALSERVER){
                DBG_ERROR(pageId + " is not init,but now is dial,SendAM anyway.");
                setTimeout(function () {
...
function onAppStateChanged(val) {
    ...
    DBG_ALWAYS("am notify : "+val + "; pageId = " + pageId);
    if (("navigator" == strvec[0] && "resumed" == strvec[2]) ||
        ...
        if (!!hiWebOsFrame.myLauncher && hiWebOsFrame.myLauncher.visible) {
            ...
            } else if (g_launcherBrand == "VIDAALite" || g_launcherBrand == "VIDAALiteU2") {
...
//锁键延时正好与HImedia内初始化时间相同
            ...
            try {
                LGReport.GTAPPRunStart(hiWebOsFrame[pageId].operateData.logParam.AppName,hiWebOsFrame[pageId].operateData.logParam.LaunchSource);
                //debugPrint("logReport__________begin", DebugLevel.WARNING);
...
//                }
            ...
            try {
                LGReport.GTAPPRunClose(hiWebOsFrame[pageId].operateData.logParam.AppName,hiWebOsFrame[pageId].operateData.logParam.LaunchSource);
            ...
            if (appStateObj.changeApp) {
                ...
                hiWebOsFrame.createPage("app_bridge", null, hiWebOsFrame[pageId].origin, null, function (a) {
                    ...
                    if ("launcher_allapps" == appStateObj.param.pageId) {
                        appStopping = false;
                        resumeDTV();
                        if (g_launcherBrand == "VIDAALite" || g_launcherBrand == "SA_OEM" || g_launcherBrand == "VIDAALiteU2") {
                            recoverMuteWhenAppStopped();
                        }
            ...
            if ("livetv" == hiWebOsFrame[pageId].origin.module
                ...
                || "app" == hiWebOsFrame[pageId].origin.module
                || "accuweather" == hiWebOsFrame[pageId].origin.module) {
                closeDOthersModule("livetv");
                setWindowSizeLater(0, 0, 1920, 1080);
                hiWebOsFrame.blankPage.open();
                hiWebOsFrame.blankPage.hiFocus();
                ...
                DBG_INFO("isPageExist:"+hiWebOsFrame.isPageExist("VIDAAU2MainTitlePage"));
                DBG_INFO("VIDAAU2LauncherCreateFromSourceKey:"+VIDAAU2LauncherCreateFromSourceKey);
                if (hiWebOsFrame.isPageExist("myLauncher") || hiWebOsFrame.isPageExist("OEMlauncherPage")
                    || hiWebOsFrame.isPageExist("VIDAALiteNavPage") || hiWebOsFrame.isPageExist("VIDAAU2MainTitlePage") || hiWebOsFrame.isPageExist("NoblexLauncher_page")) {
                    if (g_launcherBrand == "VIDAALiteU2" && hiWebOsFrame.isPageExist("VIDAAU2MainTitlePage")) {
                        if (!VIDAAU2LauncherCreateFromSourceKey) {
                    ...
                    else if (g_launcherBrand == "VIDAALiteU2") {
                        createVIDAALiteU2launcher();
                    }
                    else {
        ...
        case "network_error":
            endLoadingOrUnlockKey();
            hiWebOsFrame.createPage('appCtrNetworkDisconnectDialog', null, null, null, function (appCtrlPage) {//rmdr_edit_page
                hiWebOsFrame["appCtrNetworkDisconnectDialog"] = appCtrlPage;
                appCtrlPage.open();
                appCtrlPage.hiFocus();
                keyboard.registerKeyCodes([VK_ENTER,VK_BACK]);
                keyboard.setWantGroup(6);
            });
            break;
        case "start_dail":
            if(GLOBAL.HOTEL_MODE && "app_netflix" == pageId){
                DBG_ERROR("onAppStateChanged:case start_dail HOTEL MODE NOT START NETFLIX");
                return;
            }
            //增加dlna上推送时对标志位的处理   MT5655EU-1308
        ...
        case "hotkey":
            if(GLOBAL.HOTEL_MODE && "app_netflix" == pageId){
                DBG_ERROR("onAppStateChanged:case hotkey HOTEL MODE NOT START NETFLIX");
                return;
            }
        ...
        case "dail":
            if(GLOBAL.HOTEL_MODE && "app_netflix" == pageId){
                DBG_ERROR("onAppStateChanged:case dail HOTEL MODE NOT START NETFLIX");
                return;
            }
            if ("app_BBC_iPlayer" == pageId) {
                BBCDialStop();
...
function getLogReportParam(cmd, pageId, ori, isHotKey, storeType, isStandby, crntPageId,isDialserver) {
...
//	cmd = hiWebOsFrame.getCurrentArea() == "SA" ? cmd.indexOf("file:///") > -1 && cmd[cmd.length-1] != 0 ? cmd.replace("file:///","file://") : cmd : cmd;
    ...
    if (cmd.indexOf("file:///3rd_rw/UI/hisenseUI/mediaIndex.html")>-1) {
        tmp_param.AppName = "Media";
        return tmp_param;
    }

    if (!!pageId) {
        if (!!isHotKey ||!!isStandby||!!isDialserver) {
            ...
            if(tmplocalVar == "SA_OEM"){
                ...
                logParam = getAppNameByUrl(cmd);//omg
                // vidda 1.0
            }
        }
//        else if (ori == "allapps") {
...
//        }
    ...
    tmp_param.AppName = logParam;
    debugRM(JSON.stringify(tmp_param));
    return tmp_param;
}
...
function getPageIdByAppName(appName) {
    ...
    switch (appName) {
        case "vudu_movies":
            pageId = "app_vudu";
            break;
        case "amazon_ignition":
            pageId = "app_amazon";
            break;
        //case "foxxum":
        case "opera4x":
            DBG_ERROR("opera4xType    "+opera4xType);
            if(!!opera4xType){
                pageId = opera4xType;
            }else{
                pageId = "app_lau_browser";
            }
            break;
        default :
            pageId = "app_" + appName;
...
function chl_startPVRTShiftDialog(prgrm, keyValue) {
    ...
    if(prgrm.startTime == 0 && prgrm.endTime ==0)
    {
        prgrm.startTime = getSYSLongTime();
        prgrm.endTime = prgrm.startTime +3600;
    }
...
function startTshiftMediaDialog(module_id, func) {
    ...
    hiWebOsFrame.createPage('tshiftMediaDialog', null, null, null, function (page) {
        ...
        hiWebOsFrame.tshiftmedia.timer = setTimeout(exitTshiftMediaToTMsg, 60 * 1000);
        DBG_ERROR("show tshiftMediaDialog");
        if (module_id === "pvr" && typeof func === "function") {
            func();
        }
    });
}
...
function launchTshift() {
    ...
    hiWebOsFrame.createPage('tshiftProgressPage_id', null, null, null, function (page) {
        ...
        try {
            var playState = tp_common.getTimeShiftState();
...
function tShiftPlayStatusChanged(value) {
    ...
    if (status != TimeshiftModelDefines.ENUM_SL2_TVAPI_TSHIFT_PLAY_STATE_STOPPED) {
    ...
    else if (status == TimeshiftModelDefines.ENUM_SL2_TVAPI_TSHIFT_PLAY_STATE_STOPPED) {
        if (!!hiWebOsFrame.tshiftProgressPage) {
            if (!!hiWebOsFrame.tshiftProgressPage.timeOut) {
                clearTimeout(hiWebOsFrame.tshiftProgressPage.timeOut);
...
function isTimeShiftStatus() {
    ...
    return tp_common.isTimeShifting();
...
function homeSourceKeyStopPvrOrTShiftCallBack(stopWho) {
    ...
    if(g_launcherBrand == "VIDAALiteU2"){
        oneKeyOpenVIDAAU2LauncherInput();
    }else if(g_launcherBrand == "VIDAALite"){
...
function homeKeyStopPvrOrTShiftCallBack(stopWho) {
    ...
    if (g_launcherBrand == "SA_OEM") {
        ...
        if (hiWebOsFrame.isPageExist("myLauncher") || hiWebOsFrame.isPageExist("VIDAAU2MainTitlePage") || hiWebOsFrame.isPageExist("NoblexLauncher_page")) {
            hiWebOsFrame.myLauncher.open();
            hiWebOsFrame.myLauncher.hiFocus();
        }
        else {
...
function startToPvr() {
    ...
    //创建pvr页面
    tp_common.updatePvrTimeInfo(function (record_info) {
        if(hiWebOsFrame.getCurrentPageId() == "dialog_common" ){
            return;
        }
        hiWebOsFrame.createPage("pvrtshift_pvr_page", null, null, null, function (page) {
            ...
            try {
                ...
                opeData.recordProgressBar.MinValue = record_info.begin_time;
                opeData.recordProgressBar.MaxValue = record_info.end_time;
                opeData.recordProgressBar.DefaultValue = record_info.current_time;
...
function changeChannelToStartRecord(crntChannel, lastChanel) {
    ...
    //     }
    // }
    if (changeChannelByPvr) {
        tp_common.onChannelChanged(crntChannel);
    }
}
...
function onTvsetLocationChaged(country) {
    try {
        debugE("onTvsetLocationChaged" + country)
        ...
        if (hiWebOsFrame.getCurrentArea() == "EU") {
            ...
            ENABLE_FVP = tv ? (1 == parseInt(model.basicSetting.getDisclaimer()) && isUK && getCompileFVPVersion()) : true;
        }
    } catch (e) {
        debugE(e.message)
    }
...
BookRepeatMode();
BookRepeatMode.SUNDAY = 1 << 0;
BookRepeatMode.MONDAY = 1 << 1;
BookRepeatMode.TUESDAY = 1 << 2;
BookRepeatMode.WEDNESDAY = 1 << 3;
BookRepeatMode.THURSDAY = 1 << 4;
BookRepeatMode.FRIDAY = 1 << 5;
BookRepeatMode.SATURDAY = 1 << 6;
BookRepeatMode.ONCE = 128;
BookRepeatMode.DAILY = 0;
...
function refreshEPGModule(){
    try{
        if(hiWebOsFrame.getCurrentPageId() == "epg"){
            hiWebOsFrame.getCurrentPage().rewriteDataOnly();
        }
    }catch(ex){DBG_ERROR('refreshEPGModule is error'+ex.message)}
}
...
function openBookEditPage(chnl, prgrm, isContain, manualStop, bookType, ori) {
    ...
    hiWebOsFrame.createPage(pageId, null, ori, null, function (p) {
        hiWebOsFrame[pageId] = p;
        hiWebOsFrame[pageId].origin = ori;
...
function checkEnterEPGstate(){
    try{
        if (livetvchlist.getChannelListInitState() || livetvchlist.getChannelChangeFlag()){
            return false;
        }
        ...
        if(SourceList.TV != livetvmain.getCurrentSourceInnerId()){
            return false;
        }
        var curChannel = livetvmain.getCurrentChannelInfo();
        if(!!curChannel && TVTYPE.ATV != curChannel.type){
            return true
        }else{
            return false;
        }
...
function openEPGPage() {
    ...
    if (tv && tp_common.checkLeaveTimeshiftOrPvr(openEPGPage)) {
        return;
    }
...
function openRemindRecordSettingPage() {
    ...
    if (tv) {
        var program = {
            index: isNaN(prgrm.index) ? -1 : prgrm.index,
            uid: prgrm.channelUid,
            list_uid: prgrm.listUid,
            play_id: prgrm.playId,
            program_name: prgrm.title,
            begin_time: prgrm.startTime,
            end_time: prgrm.endTime,
            duration: prgrm.endTime - prgrm.startTime,
            book_type: prgrm.book_type,
            repeat_type: prgrm.repeat_type,
            channel_name: prgrm.channelName,
            channel_number: prgrm.channelNumber
        };
        openBookEditPage(null, program, false, true, BookType.RECORD, hiWebOsFrame[LiveTVModule.MAIN])
...
function changeSourceTo(uid) {
    tv && model.source.InputSet("" + uid);
    ReadInputRecent("" + uid);
}

function createVIDAALiteU2launcher() {
    try {
        var id = "VIDAAU2MainTitlePage";
        if(hiWebOsFrame.getCurrentBrand() == "nob"){
            id = "NoblexLauncher_page";
        }
        hiWebOsFrame.createPage(id, null, null, null, function (page) {
            hiWebOsFrame.myLauncher = page;
            hiWebOsFrame.myLauncher.origin = null;
...
/*****
 * compile Fvp or FHD version
 * @returns {boolean}
 * FVP return true
 */
function getCompileFVPVersion(){
    try{
        if(tv){
            return (1 == model.system.getFreeView());
        }else{
            return false;
        }
    }catch(ex){DBG_ERROR(ex.stack)}
...
function showLauncherDefaultTip() {
    $("#launcher_default_data_tip").css("display","block");
}
...
function showLauncherDebugTip() {
    $("#launcher_debug_data_tip").css("display","block");
}

function hideLauncherDebugTip() {
    $("#launcher_debug_data_tip").css("display", "none");
}
...
//        hiWebOsFrame.startLoading(5, "stoppvr");
        if (isMainArchiveRecording()) {
         ...
         //   model.pvr.StopRecordCallBack = recoverFocusToLiveTV;
            setTimeout(function () {
                DBG_ALWAYS("model.pvr.StopRecord()");
                tp_common.stopRecord(recoverFocusToLiveTV);
            }, 100);
        }
        if (isTimeShiftStatus()) {
        ...
        //    model.timeshift.timeShiftStopCallback = recoverFocusToLiveTV;
            setTimeout(function () {
                tp_common.stopTimeShift(recoverFocusToLiveTV);
            }, 100);
        }
    } catch (ex) {
        debugPrint("error: " + ex.message);
...
function startLauBrowser(url) {
    ...
    sendAM(":am,opera4x,:resume=[-s,hisense,-u," + url + "]");
    // sendAM(':am,am,:start=[lau_browser,-u,' + url + ']');
}
function startTVStore(url, type, full) {
    if ("" !== full) {
        sendAM(":am,opera4x,:resume=[-s,store,-u," + full + "]");
    }
    else {
        var cmd = "";
        if ("" !== url) cmd += ("-u," + url + ",");
...
function startHiBrowser(url) {
    if ("" === url) {
        ...
        sendAM(':am,opera4x,:resume=[-s,hibrowser,-u,' + url + ']');
    }
}
...
function updateDateFormat() {
    ...
    if ((GLOBAL.CURRENT_COUNTRY == "IRN" && GLOBAL.CURRENT_LANGUAGE == "per")
        ...
        format = "ymd";
    } else if (hiWebOsFrame.getCurrentArea() == "NA" && GLOBAL.CURRENT_COUNTRY != "MEX") {
        format = "mdy";
    }

    //set separator
    if (hiWebOsFrame.getCurrentArea() == "SA"
        || hiWebOsFrame.getCurrentArea() == "NA"
        || GLOBAL.CURRENT_COUNTRY == "LTU") {
        separator = "-";
...
var ENUM_INDEX_BEGIN = 0;
function ToastType() {
    ENUM_INDEX_BEGIN = 0;
}

function toastOnSourceDetectChanged(val) {
    DBG_ERROR("notificationToast!!!!!!!!!!!!" + val);
    DBG_ERROR("current page id :" + hiWebOsFrame.getCurrentPage().id  + " "+ factoryMode);
    if ((checkIsAppOn() && hiWebOsFrame.getCurrentPage().id == "app_netflix") || model.system.getNotificationSwitch() == 0
        || FACTORY_MODE_ENUM.MODE_FACTORY == factoryMode) {
        $("#notification_toast").css("display", "none");
        g_toastIsShow = false;
    } else {
        g_toastType = ToastType.INPUT;
        showNotificationToast(val);
    }
}

ToastType();
ToastType.INPUT = ENUM_INDEX_BEGIN++;
ToastType.NETWORKSET = ENUM_INDEX_BEGIN++;
ToastType.DLNA = ENUM_INDEX_BEGIN++;
ToastType.YOUTUBE =ENUM_INDEX_BEGIN++;
ToastType.CHILD_LOCK = ENUM_INDEX_BEGIN++;


var g_toastType = ToastType.INPUT;
var g_toastIsShow = false;
var g_toastTimeout = 0;
var reportToastMsgId='';

function showNotificationToast(val) {
    var name = "";
    var icon = "";
    if (g_toastType == ToastType.INPUT) {
...
//            2: "component",
        ...
        var array = val.split("-");
        if (array.length > 1) {
            name = sourceMap[array[0]];
            reportToastMsgId=name;
            for (var x = 0; x < inputsData.sourceList.length; x++) {
                if (array[0] == inputsData.sourceList[x].id) {
                    name = inputsData.sourceList[x].name;
                    if (!!inputsData.sourceList[x].rename) {
                        name = inputsData.sourceList[x].rename;
                    }
                    break;
                }
            }
            icon = "img/inputs/la_ic_" + sourceMap[array[0]] + "_connected.png";
            if (array[1] == 1) {
                icon = "img/inputs/la_ic_" + sourceMap[array[0]] + "_connected.png";
                name = name + " "+getCurrentContentLanguage("Signal received");
            } else {
                icon = "img/inputs/la_ic_" + sourceMap[array[0]] + "_disconnected.png";
                name = name + " "+getCurrentContentLanguage("Signal lost");
            }
        }

        $("#notification_toast_img").attr("src", VIDAAU2LauncherBaseDir + icon);
        $("#notification_toast_text").attr("class","notification_toast_text");
        $("#notification_toast_text").text(name);
        $("#notification_second_toast_text").css("display", "none");
        $("#notification_toast").attr("class","notification_toast");
        $("#notification_toast").css("display", "block");
    }else if(g_toastType == ToastType.NETWORKSET){
        reportToastMsgId="network";
        $("#notification_toast_img").attr("src", VIDAAU2LauncherBaseDir + "img/ic_network.png");
        $("#notification_toast_text").attr("class","notification_toast_text_network");
        $("#notification_toast_text").text(getCurrentContentLanguage("Set up the network to gain full access of Smart TV features."));
        $("#notification_second_toast_text").text("Press Menu to setup");
        $("#notification_second_toast_text").css("display", "block");
        $("#notification_toast").attr("class","notification_toast_network");
        $("#notification_toast").css("display", "block");
    }else if(g_toastType == ToastType.DLNA){
        reportToastMsgId="dlna";
        $("#notification_toast_img").attr("src", VIDAAU2LauncherBaseDir + "img/ic_dlna.png");
        $("#notification_toast_text").attr("class","notification_toast_text_network");
        $("#notification_toast_text").text(getCurrentContentLanguage("Share video, music or other content from another device on to your TV screen."));
        $("#notification_second_toast_text").text("Press Menu to setup");
        $("#notification_second_toast_text").css("display", "block");
        $("#notification_toast").attr("class","notification_toast_network");
        $("#notification_toast").css("display", "block");
    }else if(g_toastType == ToastType.YOUTUBE){
        $("#notification_toast_img").attr("src", VIDAAU2LauncherBaseDir + "img/ic_network.png");
        $("#notification_toast_text").attr("class","notification_toast_text_network");
        $("#notification_toast_text").text(getCurrentContentLanguage("Wake-on-LAN and Wake-on-WLAN have been turned on."));
        $("#notification_second_toast_text").css("display", "none");
        $("#notification_toast").attr("class","notification_toast_network");
        $("#notification_toast").css("display", "block");
    }
    else if(g_toastType == ToastType.CHILD_LOCK) {
        $("#notification_toast_img").attr("src", VIDAAU2LauncherBaseDir + "img/ic_error.png");
        $("#notification_toast_text").attr("class", "notification_toast_text");
        $("#notification_toast_text").text(getCurrentContentLanguage("Child lock activated"));
        $("#notification_second_toast_text").css("display", "none");
        $("#notification_toast").attr("class", "notification_toast");
        $("#notification_toast").css("display", "block");
    }
    ...
    g_toastIsShow = true;
    g_toastTimeout = setTimeout(hideNotificationToast, 5 * 1000);
}
...
function initKeyValueMap(){
    try{
        if(!CONST_KEYVAlUEMAP){
            CONST_KEYVAlUEMAP =[]
        }else{
            if(!CONST_KEYVAlUEMAP.length){
                var curKeyValue = hiWebOsFrame.getKeyValues();
                if(!curKeyValue){
                    DBG_ERROR('init keyValue error:'+curKeyValue);
                }else{
                    for(var dp in curKeyValue){
                       if(curKeyValue.hasOwnProperty(dp)){
                           var name = String.prototype.split.call(dp,'key');
                           var keyName = name ? name[1] ? name[1] : name[0] : ''
                           if(0 <= keyName.indexOf("VK_")  ){
                               continue;
                               //keyName = String.prototype.split.call(keyName,'VK_')[1];
                           }
                           CONST_KEYVAlUEMAP[curKeyValue[dp]] = keyName;
                       }
                    }
                }
            }
...
function logKeyProcess(keyCode){
    try{
        switch (keyCode){
            case VK_UP:
            case VK_DOWN:
            ...
            case VK_VOLUME_UP:
            case VK_VOLUME_DOWN:
                if(GLOBAL.LOG_KEY_ARRAY.length >= 8){
                    GLOBAL.LOG_KEY_ARRAY.shift();
                }
                addLogKey(keyCode);
                break;
            default :
        ...
        function addLogKey(keyCode){
            switch(keyCode){
                case VK_UP:
                    GLOBAL.LOG_KEY_ARRAY.push({ key:LogKeyArray.up,time:new Date().getTime()});
                    break;
                case VK_DOWN:
                    GLOBAL.LOG_KEY_ARRAY.push({ key:LogKeyArray.down,time:new Date().getTime()});
                    break;
                case VK_LEFT:
                    GLOBAL.LOG_KEY_ARRAY.push({ key:LogKeyArray.left,time:new Date().getTime()});
                    break;
                case VK_RIGHT:
                    GLOBAL.LOG_KEY_ARRAY.push({ key:LogKeyArray.right,time:new Date().getTime()});
                    break;
                case VK_VOLUME_UP:
                    GLOBAL.LOG_KEY_ARRAY.push({ key:LogKeyArray.volUp,time:new Date().getTime()});
                    break;
                case VK_VOLUME_DOWN:
                    GLOBAL.LOG_KEY_ARRAY.push({ key:LogKeyArray.volDown,time:new Date().getTime()});
                    executeSearchLogAction();
                    break;
                default :
                    DBG_ERROR("key is error, keyCode:"+keyCode);
                    break;
            }
        }
        function clearLogKeyArray(){
            GLOBAL.LOG_KEY_ARRAY = [];
        }

        function keyArrayIsRequired(keyArray){
            var _returnVal = true;
            var requiredKeySeq=[LogKeyArray.left,LogKeyArray.volDown,LogKeyArray.right,LogKeyArray.volUp,LogKeyArray.up,
                LogKeyArray.volUp,LogKeyArray.down,LogKeyArray.volDown];
            if(keyArray.length == requiredKeySeq.length ){
                for(var i= 0;i<requiredKeySeq.length;i++){
                    if(requiredKeySeq[i]!=keyArray[i].key){
                        _returnVal = false;
                        break;
                    }
                }
        ...
        function executeSearchLogAction(){
            var keyArray = GLOBAL.LOG_KEY_ARRAY;
            var timer = 10000;
            if(keyArray.length == 8){
                if(keyArray[7].time - keyArray[0].time < timer && keyArrayIsRequired(keyArray)){
                    DBG_ALWAYS("model.system.importErrorLog()");
                    model.system.importErrorLog();
                }else{
                    if(keyArray[7].time - keyArray[0].time < timer){
                        DBG_INFO("key Array seq is not required :"+objToString(keyArray));
                    }else{
                        DBG_INFO("time out :"+objToString(keyArray));
                    }
                }
            }else{
                DBG_ERROR('keyArray is not ready:'+objToString(keyArray));
            }
        }
    }
    catch(ex){
 ...
 *将按键发送给cec设备
 * @param keyCode 键值
 * @param v keystate 1 2 8 1down 2press 8 up
 */
function sendKeyToCEC(keyCode, v){
    var ltrLan = ["ara","per","hbr"];
    var _keyCode = keyCode;
    if(ltrLan.indexOf(GLOBAL.CURRENT_LANGUAGE) >= 0){
        if(keyCode == VK_RIGHT) {
            _keyCode = VK_LEFT;
    ...
    if(tv) {
        DBG_ERROR("call sendKeyToCEC UI_keyState = "+UI_keyState);
        if(UI_keyState != 8) { //过滤Up按键
            model.cec.sendKeyToCEC(CEC_KEYMAP[keyCode], UI_keyState);
        }

    }
    else{
         UIObserver.publishMessage(UIObserver.MESSAGE_NAME.VOLUME_CHANGED, v + (VK_VOLUME_DOWN == keyCode ? -1 : 1));
    }
}


var storeModeKeyValueStr = "";
function checkPopUpBissKeyPage(keyCode) {
    var keyValue = keyCode - VK_0;
    if (keyValue < 0 || keyValue > 9) {
        DBG_ERROR("keyCode error");
        return;
    }
    if (storeModeKeyValueStr.length >= 4) {
        storeModeKeyValueStr = (storeModeKeyValueStr + keyValue).slice(-4);
    }else{
        storeModeKeyValueStr = storeModeKeyValueStr + keyValue;
    }
    if (storeModeKeyValueStr == "0000" && checkStoreMode()) {
        clearBissKeyKeyValueStr();
        //enter seller setting
        hiWebOsFrame.createPage('setting_sys_seller_setting_page', null, null, null, function (sellersettingpage) {   //sellersettingpage
            hiWebOsFrame.settingSellerSettingpage = sellersettingpage;
            hiWebOsFrame.settingsysqS.close();
            sellersettingpage.open();
            sellersettingpage.hiFocus();
        });
    }
}

function clearBissKeyKeyValueStr() {
    storeModeKeyValueStr = "";
}

function numberKeyAndUpDownKeyHandlrOnQsPage(a, b, keyCode) {
    switch (keyCode) {
        case VK_0:
            checkPopUpBissKeyPage(keyCode);
            break;
        case VK_1:
        case VK_2:
        case VK_3:
...
getLauncherTheme = function () {
    DBG_ERROR("getLauncherTheme:"+hiWebOsFrame.getCurrentBrand());
    switch (hiWebOsFrame.getCurrentBrand()) {
        case "dev":
        case "pan":
        case "riv":
...
var msgBoxToastTimer = null;
function openMsgBoxToast(key){
    if(!key) return;
    var str = getCurrentContentLanguage(key);
    $("#mymsgToastContent").html(str);
    $("#mymsgToast").css("display","block");
    var height = parseInt($("#mymsgToastWrap").css("height"));
    var top = (1080 - height)/2;
    $("#mymsgToastWrap").css("top",top+"px");
    clearTimeout(msgBoxToastTimer);
    msgBoxToastTimer = setTimeout(function(){
        closeMsgBoxToast();
    },3000);
}

function closeMsgBoxToast(){
    $("#mymsgToast").css("display","none");
    clearTimeout(msgBoxToastTimer);
}
...
function traceFunction(){
    ...
    while (caller) {
    stack.unshift(getFunctionName(caller));caller = caller && caller.caller;
    }
    DBG_ERROR('functions on stack:' + '\n' + stack.join('\n'))
};
