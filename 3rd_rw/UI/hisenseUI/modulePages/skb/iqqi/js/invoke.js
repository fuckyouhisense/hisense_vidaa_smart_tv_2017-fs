...
function invokeSKB() {
    ...
    if(this.inputTitle == null || typeof this.inputTitle == "undefined" || this.inputTitle == "") {
        inputTitle = getCurrentContentLanguage("Please Input");
    } else {
        inputTitle = getCurrentContentLanguage(this.inputTitle);
    }
            ...
            hiWebOsFrame.createPage('iqqi', '', _this.page, zindex, function(a) {
                ...
                try {
                    ...
                    if(a.operateData.InputManager == null) {
                        a.operateData.InputManager = new InputManager(sid, inputAttr, inputMethod, maxlength, _this.min, _this.max, iqqiGetCurrentDisplay(a.page.operateData), inputTitle);
                    }
                    else {
                        a.operateData.InputManager.resetTo(sid, inputAttr, inputMethod, maxlength, _this.min, _this.max, iqqiGetCurrentDisplay(a.page.operateData), inputTitle);
                    }
