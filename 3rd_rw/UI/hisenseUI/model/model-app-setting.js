...
}
{
    ...
    App_settingModelDefines.SL2_TVAPI_I32_APP_SETTING_ALL_APP_STATE = "tvapi.i32.app.setting.all.app.state";
...
function App_settingModel(parentModel) {
    ...
    this.registerStringObject(
        ...
        null, null);
    this.registerStringObject(App_settingModelDefines.SL2_TVAPI_I32_APP_SETTING_ALL_APP_STATE,
        "getAppState", "setAppState", "onAppStateChaged",
        null, null);
