...
//{
//    debugE("onOadDownloadProgressChaged"+value);
...
function StartFirmwareUpdate(origin, value) {
    try {
        if(value==4) {
            try {
                //var upgradetype = tv?model.softupdate.getHisenseUpgradeMode(): 1;
                //debugE("get the software update type is  " + upgradetype);
                //if (upgradetype != 2) {
                hiWebOsFrame.createPage('setting_update_ver_page', null, origin, null, function (verinfo) {
                        hiWebOsFrame.settingsupdateverinfo=verinfo;
                        initUpdateVersionData();
                        //PageDateSettingUpdateverinfo.operateData.curver= tv?model.softupdate.getCurrentPacket():"V1.00.00.00";
                        //var temp=tv?model.softupdate.getHisenseCurrentVersion():"V1.00.00.02";
            ...
            hiWebOsFrame.unLockAllKeys();
                ...
                //{
                //
                //    hiWebOsFrame.createPage('setting_update_ver_page11',null, origin, 5,function(verinfo) {
                //        hiWebOsFrame.settingsautoupdate = verinfo;
                //        PageDateSettingUpdateverinfo.operateData.curver=tv?model.softupdate.getCurrentPacket():"V1.00.00.00";
                //        PageDateSettingUpdateverinfo.operateData.newver =tv?model.softupdate.getHisenseCurrentVersion():"V1.00.00.02";
                //        if(tv){
                //            var temp=model.softupdate.getHisenseVersionDescription();
                //        }else{
                //            temp = "-english4564供观赏的自然风光、景物，包括自444然景观和人4444999文景观。是由光对物的反在中甚至写景多于言情，几乎和旅游打成了一片。 \r\n\r\n南朝 宋鲍照《绍古辞》之七：“怨咽对风景，闷My father was a self-taught mandolin player. He was one of the best string instrument players in our town. He could not read music, but if he heard a tune a few times, he could play it. When he was younger, he was a member of a small country music b";
            ...
            //升级下载成功提示页面
            hiWebOsFrame.createPage('settingUpgradeDownloadingOkId',null, origin, null,function(page){
                hiWebOsFrame.settingsupdatedownloadingok=page;
                hiWebOsFrame.settingsupdatedownloadingok.rewriteDataOnly();
                hiWebOsFrame.unLockAllKeys();
                hiWebOsFrame.settingsupdatedownloadingok.open();
                hiWebOsFrame.settingsupdatedownloadingok.hiFocus();
            });

        }else if (value == 104) {
            //network disconnected
            hiWebOsFrame.createPage('setting_update_report_page',null, origin, null,function(page){
                hiWebOsFrame.settingsupdatereport=page;
                PageDataSetttingUpdateReport.operateData.curdatatype = 3;
                hiWebOsFrame.settingsupdatereport.rewriteDataOnly();
                hiWebOsFrame.unLockAllKeys();
                hiWebOsFrame.settingsupdatereport.open();
                hiWebOsFrame.settingsupdatereport.hiFocus();
            });
        }else if (value == 201) {
            //upgrade fail
            hiWebOsFrame.createPage('setting_update_report_page',null, origin, null,function(page){
                hiWebOsFrame.settingsupdatereport=page;
                PageDataSetttingUpdateReport.operateData.curdatatype=2;
                hiWebOsFrame.settingsupdatereport.rewriteDataOnly();
                hiWebOsFrame.unLockAllKeys();
                hiWebOsFrame.settingsupdatereport.open();
                hiWebOsFrame.settingsupdatereport.hiFocus();
            ...
            //not enough space
            hiWebOsFrame.createPage('settingUpgradeSpaceId',null, origin, null,function(page){
                hiWebOsFrame.settingupdatedspace=page;
                hiWebOsFrame.settingupdatedspace.rewriteDataOnly();
                hiWebOsFrame.unLockAllKeys();
                hiWebOsFrame.settingupdatedspace.open();
                hiWebOsFrame.settingupdatedspace.hiFocus();
            });
        }else if (value == 203) {
            //内存不足提示页面
            hiWebOsFrame.createPage('settingUpgradeMemoryId',null, origin, null,function(page){
                hiWebOsFrame.settingsupdatememory=page;
                settingUpgradeMemoryOkData.operateData.parentpage="manual";
                hiWebOsFrame.settingsupdatememory.rewriteDataOnly();
        hiWebOsFrame.unLockAllKeys();
                hiWebOsFrame.settingsupdatememory.open();
                hiWebOsFrame.settingsupdatememory.hiFocus();
    });
  }
    } catch (e) {
        DBG_ERROR(e.message)
...
function sysUpgradeInit() {
    try {
        ...
        model.softupdate.onDownloadProgressChaged = onOTADownloadProgressChanged;
        setTimeout(function(){
...
function recoverUpgradenotify(){
    ...
    DBG_ALWAYS("recoverUpgradenotify ");
}
var upgradeType=0;
var onOTAUpdateNotify = function(value){
    DBG_ERROR("onOTAUpdateNotify"+value)
    if (tv) {
    ...
    if(value==4){
        ...
        tv?model.softupdate.StartDownload():debugPrint("downloading...");
        //hiWebOsFrame.createPage('setting_update_toast_page', null, null, null, function (page) {
        //    hiWebOsFrame.settingsupdatetoastpage = page;
        //    PageDateSettingUpgradeprogressToast.operateData.curtype = 4;
        //    PageDateSettingUpgradeprogressToast.operateData.curprogress = tv ? model.softupdate.getDownloadProgress() : 60;
        //    hiWebOsFrame.settingsupdatetoastpage.rewriteDataOnly();
        //    hiWebOsFrame.settingsupdatetoastpage.open();
        //});
       // autoUpgradeflag=false;
        DBG_ALWAYS("start OTA download");
    }
}
function onOTADownloadProgressChanged(value){
    DBG_ERROR("onOTADownloadProgressChanged" + value);
    if (value >= 0 && value < 100) {
        DBG_INFO("current value is:" + value );
        if(hiWebOsFrame.getCurrentPageId()=="setting_Upgrade_Progress_Page")  //setting_Downloading_Progress_Page
        {
            hiWebOsFrame.lockAllKeys();
            PageDateSettingUpdateprogress.operateData.curprogress=value;
            hiWebOsFrame.settingsupdateprogresspage.rewriteDataOnly();
            hiWebOsFrame.unLockAllKeys();
        }
        else {
            if(!!hiWebOsFrame.settingsupdatetoastpage){
                PageDateSettingUpgradeprogressToast.operateData.curprogress=value;
                hiWebOsFrame.settingsupdatetoastpage.rewriteDataOnly();
            }
            //hiWebOsFrame.createPage('setting_Upgrade_Progress_Page',null, null, null,function(page){
            //    DBG_INFO("setting_Upgrade_Progress_Page value is:" + value );
            //    hiWebOsFrame.settingsupdateprogresspage=page;
            //    PageDateSettingUpdateprogress.operateData.curprogress=value;
            //    hiWebOsFrame.settingsupdateprogresspage.rewriteDataOnly();
            //    hiWebOsFrame.settingsupdateprogresspage.close();
            //    hiWebOsFrame.unLockAllKeys();
            //});
        }
    }
        ...
        try {
            if(hiWebOsFrame.getCurrentPageId()=="setting_Upgrade_Progress_Page"||
                hiWebOsFrame.getCurrentPageId()=="settingsupdatereport"||
                hiWebOsFrame.getCurrentPageId()=="setting_update_fir_page"){
                IS_PROGRESS = true;
                try{
                    var origin=hiWebOsFrame.getCurrentPage().origin;
                    if(!!origin){
                        origin.open();
                        origin.hiFocus();
                    }
                    ...
                    if (!!hiWebOsFrame.settingsupdateprogresspage) {
                        hiWebOsFrame.settingsupdateprogresspage.destroy();
                    }
                    debugE("origin"+origin.id);
                }catch(e){
                    debugE(e.message)
                }
                if (value == 100) {
                    //升级下载成功提示页面
                    hiWebOsFrame.createPage('settingUpgradeDownloadingOkId',null, hiWebOsFrame.settingssysupdate, null,function(page){
                        hiWebOsFrame.settingsupdatedownloadingok=page;
                        hiWebOsFrame.settingsupdatedownloadingok.rewriteDataOnly();
                        hiWebOsFrame.unLockAllKeys();
                        hiWebOsFrame.settingsupdatedownloadingok.open();
                    ...
                    hiWebOsFrame.createPage('setting_update_report_page',null,hiWebOsFrame.settingssysupdate, null,function(dialog1){
                        hiWebOsFrame.settingsupdatereport=dialog1;
                        PageDataSetttingUpdateReport.operateData.curdatatype = 3;
                        hiWebOsFrame.settingsupdatereport.rewriteDataOnly();
                        hiWebOsFrame.unLockAllKeys();
                        hiWebOsFrame.settingsupdatereport.open();
                    ...
                    hiWebOsFrame.createPage('settingUpgradeSpaceId',null, hiWebOsFrame.settingssysupdate, null,function(page){
                        hiWebOsFrame.settingupdatedspace=page;
                        hiWebOsFrame.settingupdatedspace.rewriteDataOnly();
                        hiWebOsFrame.unLockAllKeys();
                        hiWebOsFrame.settingupdatedspace.open();
                    ...
                    //内存不足提示页面
                    hiWebOsFrame.createPage('settingUpgradeMemoryId',null, hiWebOsFrame.settingssysupdate, null,function(page){
                        hiWebOsFrame.settingsupdatememory=page;
                        settingUpgradeMemoryOkData.operateData.parentpage="manual";
                        hiWebOsFrame.settingsupdatememory.origin.close();
                        hiWebOsFrame.settingsupdatememory.rewriteDataOnly();
                        hiWebOsFrame.unLockAllKeys();
                        hiWebOsFrame.settingsupdatememory.open();
                        hiWebOsFrame.settingsupdatememory.hiFocus();
                    ...
                    //hiWebOsFrame.createPage('setting_sys_dialog1_page',null, hiWebOsFrame.settingssysupdate, null,function(dialog1){
                    //    hiWebOsFrame.settingsupdatedialog1=dialog1;
                ...
                if(value==100){
                    ...
                    //hiWebOsFrame.createPage('setting_sys_dialog1_page',null, null, null,function(dialog1){
                    //    hiWebOsFrame.settingsupdatedialog1=dialog1;
                    //    PageDataSetttingSysdialog1.operateData.curdatatype=3;
                    //    hiWebOsFrame.settingsupdatedialog1.rewriteDataOnly();
                    //    hiWebOsFrame.unLockAllKeys();
...
function SettingDoDownloadProcess(value){
    ...
    if (!!hiWebOsFrame.getCurrentPage()) {
        if (hiWebOsFrame.getCurrentPageId() == "chl_blankPage") {
            StartFirmwareUpdate(hiWebOsFrame.blankPage,value);
            hiWebOsFrame.blankPage.close();
        }
        else if (hiWebOsFrame.getCurrentPage().module == "launcher") {
          //  hiWebOsFrame.getCurrentPage().hiBlur();
            StartFirmwareUpdate(hiWebOsFrame.myLauncher,value);
        }
        else if (hiWebOsFrame.getCurrentPage().module == "allapps") {
          //  hiWebOsFrame.getCurrentPage().hiBlur();
            StartFirmwareUpdate(hiWebOsFrame["launcher_allapps"],value);
        }
            ...
            var crntPage = hiWebOsFrame.getCurrentPage();
            debugPrint("open upadate  On App function begin!!!"+crntPage.id);
            if ("app_lau_browser" == crntPage.id) {
                switch (appBrowser.getCurrentCommandType()) {
                    case CmdURLType.LAU_BROWSER_HIMEDIA:
                        //model......通知himedia取消按键
                        ...
                        debugPrint("open upgrade on himedia  function begin!!!");
                        // hiWebOsFrame.lockAllKeys();
                        StartFirmwareUpdate(crntPage,value);
                        //hiWebOsFrame.unLockAllKeys();
                        hiWebOsFrame.registerKeyCodesForSettingOnApp();
                        break;
                    case CmdURLType.LAU_BROWSER_PICASA:
                        debugPrint("open upgrade on  picasa function begin!!!");
                        //   hiWebOsFrame.lockAllKeys();
                        StartFirmwareUpdate(crntPage,value);
                        //   hiWebOsFrame.unLockAllKeys();
                        hiWebOsFrame.registerKeyCodesForSettingOnApp();
            ...
            //  hiWebOsFrame.lockAllKeys();
            var crntPage = hiWebOsFrame.getCurrentPage();
            //var hiWebOsPage = hiWebOsFrame.getCurrentPageId();    //,hiWebOsPage
            StartFirmwareUpdate(crntPage,value);
            // hiWebOsFrame.unLockAllKeys();
        }
        else {
...
function StartInitSetting() {
    ...
    GLOBAL.TIME_FORMAT = tv?parseInt(model.timerfunc.getTimeFormat()):0;
    GLOBAL.PARENTAL_LOCK_SWITCH = tv?parseInt(model.parentlock.getSModel()):0;
    /* add by jiaguili for the child lock*/
    try{
        GLOBAL.PARENTAL_CHILD_LOCK=tv?parseInt(model.parentlock.getChildLock(),10):0;
    }
    catch (ex) {
        DBG_ERROR(ex.message);
        GLOBAL.PARENTAL_CHILD_LOCK=0;
    }
    debugE(" GLOBAL.TIME_FORMAT" +  GLOBAL.TIME_FORMAT);
    debugE(" GLOBAL.PARENTAL_LOCK_SWITCH" +  GLOBAL.PARENTAL_LOCK_SWITCH);
    debugE(" GLOBAL.PARENTAL_CHILD_LOCK" +  GLOBAL.PARENTAL_CHILD_LOCK);
    //model.softupdate.onAutoAnnouncementChaged = onOTAUpdateNotify;
    //model.softupdate.onDownloadProgressChaged = onOTADownloadProgressChanged;
...
//            debugG('RGBSourceState: ' + RGBSourceState);
        ...
        debugG("hiWebOsFrame.getCurrentPage()" + hiWebOsFrame.getCurrentPage());

        if (checkIsAppOn() && hiWebOsFrame.getCurrentPage() == "app_netflix") {//checkIsAppOn() && hiWebOsFrame.getCurrentPage() == "app_netflix"
            debugG("netflix is on, grey off audio out");
            PageDataFirstCls.operateData.settingdisablelist[1].push(FirPageSndIdx.SndDigitalAudio);
        } else {
            debugG("no need disable audio out");
            while (-1 != $.inArray(FirPageSndIdx.SndDigitalAudio, PageDataFirstCls.operateData.settingdisablelist[1])) {    //存在,则删除
                PageDataFirstCls.operateData.settingdisablelist[1].splice($.inArray(FirPageSndIdx.SndDigitalAudio, PageDataFirstCls.operateData.settingdisablelist[1]), 1);
            }
        }


        var ARCConnected = tv ? model.cec.getIsAudioDeviceExist() : 1;//todo
        var ARCStateOn = tv ? model.cec.getHdmiDevicesArcState() : 1;
        if (ARCConnected == 1 && ARCStateOn == 1) {
            debugG("ARC on, disable SndAdvanced...");
            PageDataFirstCls.operateData.settingdisablelist[1].push(FirPageSndIdx.SndAdvanced);
        } else {
            debugG("ARC not on, no need disable SndAdvanced...");
            while (-1 != $.inArray(FirPageSndIdx.SndAdvanced, PageDataFirstCls.operateData.settingdisablelist[1])) {    //存在,则删除
                PageDataFirstCls.operateData.settingdisablelist[1].splice($.inArray(FirPageSndIdx.SndAdvanced, PageDataFirstCls.operateData.settingdisablelist[1]), 1);
            }
        }
...
function getCurDisclaimerfile(){
    var curBrand = initBrand;
    var curLanguage = GLOBAL.CURRENT_LANGUAGE;
    var curCountry= GLOBAL.CURRENT_COUNTRY;
    var brandfile=" ";
    if(hiWebOsFrame.getCurrentArea()=="SA"){
        if(curLanguage == "spa"){
            switch(curBrand){
                case 'bgh':
                    brandfile = "Disclaimer_sa_spa_bgh.html";
                    break;
                case 'nob':
                case 'jvc':
                case 'san':
                ...
                case 'shp':
                case 'psc'://NEWSAN
                    brandfile = "Disclaimer_sa_spa_newsan.html";
                    break;
                case 'his':
                case 'hisense':
                    brandfile = "Disclaimer_sa_spa_his.html";
                    break;
                case 'riv':
                    brandfile = "Disclaimer_sa_spa_riv.html";
                    break;
                case 'pan':
                    brandfile = "Disclaimer_sa_spa_pan.html";
                    break;
                case 'blu':
                    brandfile = "Disclaimer_sa_spa_blu.html";
                    break;
                default://OEM
                    brandfile = "Disclaimer_sa_spa_oem.html";
                    break;
            }
        }else if(curLanguage == "por"){
            switch (curBrand) {
                case 'nob':
                case 'jvc':
                case 'san':
                ...
                case 'shp':
                case 'psc'://NEWSAN
                    brandfile = "Disclaimer_sa_por_newsan.html";
                    break;
                case 'his':
                case 'hisense':
                    brandfile = "Disclaimer_sa_por_his.html";
                    break;
                default:
                    brandfile = "Disclaimer_sa_por_oem.html";
                    break;
            }
        }else{
            switch (curBrand) {
                ...
                case 'shp':
                case 'psc'://NEWSAN
                    brandfile = "Disclaimer_sa_eng_newsan.html";
                    break;
                case 'his':
                case 'hisense':
                    brandfile = "Disclaimer_sa_eng_his.html";
                    break;
                default://OEM
                    brandfile = "Disclaimer_sa_eng_oem.html";
                    break;
            }
        }
    }
    else if(hiWebOsFrame.getCurrentArea()=="EU"){
        ...
        if(curCountry == "AUS"){//AUS
            brandfile = "Disclaimer_em_aus.html";
        }
        else if (curBrand == "his" || curBrand == "hisense") {
            brandfile="Disclaimer_em_hisense.html"
        }
        else if (curBrand == "con") {
            if(curLanguage == "fre"){
                brandfile="Disclaimer_em_condor_fre.html"
            }else if(curLanguage == "ara"){
                brandfile="Disclaimer_em_condor_ara.html"
            }else{
                brandfile="Disclaimer_em_oem.html"
            }
        }else if(curBrand=="tat"){
            if(curLanguage == "zho"){
                brandfile="Disclaimer_em_tat_zho.html"
            }
            else {
                brandfile="Disclaimer_em_tat_eng.html"
            }
        }else if(curBrand=="ben"){
            brandfile="Disclaimer_em_ben.html"
        }
        else//oem品牌
        {
            if(curLanguage == "fre"){
                brandfile = "Disclaimer_em_oem_fre.html"
            }else if(curLanguage == "ara"){
                brandfile="Disclaimer_em_oem_ara.html"
            }else{
                brandfile="Disclaimer_em_oem.html"
            }
        }
