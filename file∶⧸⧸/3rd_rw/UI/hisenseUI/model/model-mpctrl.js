...
//    MpCtrlModelDefines.SL2_TVAPI_I32_MPCTRL_AV_UPDATE = "tvapi.mpctrl.int32.av.update";
    ...
    MpCtrlModelDefines.SL2_TVAPI_ACTION_VIDEOPLAYER_SET_AUDIO_TRACK_NUM = "tvapi.action.videoplayer.set.audio.track.num";
    MpCtrlModelDefines.SL2_TVAPI_ACTION_VIDEOPLAYER_SET_ITTX_TRACK_NUM = "tvapi.action.videoplayer.set.ittx.track.num";
    MpCtrlModelDefines.SL2_TVAPI_ACTION_VIDEOPLAYER_SET_ISUB_TRACK_NUM = "tvapi.action.videoplayer.set.isub.track.num";
    MpCtrlModelDefines.SL2_TVAPI_I32_VIDEOPLAYER_FONT_URL = "tvapi.i32.videoplayer.font.url";
    MpCtrlModelDefines.SL2_TVAPI_ACTION_VIDEOPLAYER_FAST_FORWARD = "tvapi.action.videoplayer.fast.forward";
    MpCtrlModelDefines.SL2_TVAPI_I32_VIDEOPLAYER_SET_SUBTITLE_TEXT_SIZE = "tvapi.i32.videoplayer.set.subtitle.text.size";

    MpCtrlModelDefines.SL2_TVAPI_I32_VIDEOPLAYER_AUDIO_TRACK_MAXNO = "tvapi.i32.videoplayer.audio.track.maxno";
...
//        "onStartResult2");
        ...
        this.registerIntegerObject(
            ...
            "getMpCtrlAudioTrack", "setMpCtrlAudioTrack", "onMpCtrlAudioTrackchanged", null, null);
...
//    );
//新增font接口
        this.registerIntegerObject(MpCtrlModelDefines.SL2_TVAPI_I32_VIDEOPLAYER_FONT_URL, "getMpCtrlFontUrl", "setMpCtrlFontUrl", "onMpCtrlFontUrlchanged", null, null);
...
//    );
        ...
        this.registerIntegerObject(MpCtrlModelDefines.SL2_TVAPI_I32_VIDEOPLAYER_AUDIO_TRACK_MAXNO, "getMaxAudioTrack", "setMaxAudioTrack", "onMaxAudioTrackChanged", null, null);
        this.registerStringVectorObject(
...
//    );
        ...
        //修改
        this.registerIntegerObject(
            MpCtrlModelDefines.SL2_TVAPI_I32_VIDEOPLAYER_SET_SUBTITLE_TEXT_SIZE,
            "getMpCtrlSubtitleTextSize", "setMpCtrlSubtitleTextSize", "onMpCtrlMpCtrlSubtitleTextSizechanged", null, null
        );
    }
}
