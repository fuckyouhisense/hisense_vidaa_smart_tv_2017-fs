...
}
{
    ...
    VideoModelDefines.SL2_TVAPI_I32_VIDEO_ENUM_SMOOTH_MOTION_SUPPORT= "tvapi.i32.video.enum.smooth.motion.exist";
    ...
    VideoModelDefines.SL2_TVAPI_I32_VIDEO_FOOTBALL_KEY_PICTURE_MODE = "tvapi.i32.video.football.key.picure.mode";
    // enum or defined is here

    VideoModelDefines.SL2_TVAPI_I32_VIDEO_DMP_FLAG = "tvapi.i32.video.dmp.flag";
    VideoModelDefines.SL2_TVAPI_I32_VIDEO_NETWORK_FLAG= "tvapi.i32.video.network.flag";
	  VideoModelDefines.SL2_TVAPI_I32_VIDEO_APPLY_2P_WB= "tvapi.i32.video.apply.2p_wb";
	  VideoModelDefines.SL2_TVAPI_I32_VIDEO_APPLY_10P_WB= "tvapi.i32.video.apply.10p_wb";
    
    VideoModelDefines.SL2_TVAPI_INT32_VIDEO_PANEL_WIDTH = "tvapi.int32.video.panel.width";
...
function VideoModel(parentModel) {
    ...
    this.registerIntegerObject(
        VideoModelDefines.SL2_TVAPI_INT32_VIDEO_PANEL_WIDTH,
        "getPanelWidth", "setPanelWidth", "onPanelWidthChaged",
        null, null);
    // EnumPictureModeList
    //this.registerIntegerVectorObject(
...
//	VideoModelDefines.SL2_TVAPI_ACTION_VIDEO_RESTORE_DEFAULT_PICTURE_SETTINGS=  "tvapi.action.video.reset.default.picture.settings "
   ...
   //     null, null);
    ...
    this.registerIntegerObject(
        VideoModelDefines.SL2_TVAPI_I32_VIDEO_HDMI_DYNAMIC_RANGE,
        "getHdmiDynamicRange", "setHdmiDynamicRange", "onHdmiDynamicRangeChaged",
        null, null);
    this.registerIntegerObject(
        VideoModelDefines.SL2_TVAPI_I32_VIDEO_HDMI_DYNAMIC_RANGE_EXIST,
        "getHdmiDynamicRangeExist", "setHdmiDynamicRangeExist", "onHdmiDynamicRangeExistChaged",
        null, null );
    this.registerIntegerObject(
        VideoModelDefines.SL2_TVAPI_I32_VIDEO_RGB_ONLY_MODE,
        "getRgbOnlyMode", "setRgbOnlyMode", "onRgbOnlyModeChaged",
        null, null);
    this.registerIntegerObject(
        VideoModelDefines.SL2_TVAPI_I32_VIDEO_FOOTBALL_KEY_PICTURE_MODE,
        "getLastPicMode", "setLastPicMode", "onLastPicModeChaged",
        null, null);
    ...
    this.registerIntegerObject(VideoModelDefines.SL2_TVAPI_I32_VIDEO_NETWORK_FLAG, "getNetworkFlag", "setNetworkFlag", "onNetworkFlagChaged", null, null);
