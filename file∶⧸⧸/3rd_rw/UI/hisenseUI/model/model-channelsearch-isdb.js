 ...
 */
 ...
 }
 {
	...
	//Channelsearch_isdbModelDefines.SL2_TVAPI_I32_ISDB_CHANNEL_SEARCH_FOUND_TOTAL_SERVICES= "tvapi.i32.isdb.channel.search.found.total.services";
     Channelsearch_isdbModelDefines.SL2_TVAPI_I32_ISDB_CHANNEL_SEARCH_ANA_FINE_TUNE= "tvapi.i32.isdb.channel.search.ana.fine.tune";
     Channelsearch_isdbModelDefines.SL2_TVAPI_ACTION_ISDB_CHANNEL_SEARCH_ANA_FINE_TUNE_CONFIRM = "tvapi.action.isdb.channel.search.ana.confirm";
...
//	Channelsearch_isdbModelDefines.SL2_TVAPI_ACTION_ISDB_CHANNEL_SEARCH_STOP=  "tvapi.action.isdb.channel.search.stop "
        ...
        //atv fine tuning
        this.registerIntegerObject(
            Channelsearch_isdbModelDefines.SL2_TVAPI_I32_ISDB_CHANNEL_SEARCH_ANA_FINE_TUNE,
            "getAtvFineFrequency", "setAtvFineFrequency", "onAtvFineFrequencyChaged",
            null, null, "getAtvFineOriFrequency");
        //Save
        this.registerActionObject(
            Channelsearch_isdbModelDefines.SL2_TVAPI_ACTION_ISDB_CHANNEL_SEARCH_ANA_FINE_TUNE_CONFIRM,
            [
                {name: "AtvFineFreSave", method: function (object, flag, Frequency) {
                    return object.invoke(flag, Frequency);
                }}
            ], "null"
        );
    }
